    ...
    it("fails when passed a file with a syntax error", async () => {
        ...
        await assert.rejects(
            ...
            ({ code, stdout, stderr }) => {
                ...
                "\x1B[0m  \x1B[2m41:1\x1B[22m  \x1B[31merror\x1B[39m  Failed to parse JSON from 'doesn't allow this comment': Expected property name or '}' in JSON at position 1\x1B[0m\n" +
