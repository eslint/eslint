    ...
    describe("/* eslint-disable */ comments without rules", () => {
        it("keeps problems before the comment on the same line", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 1, column: 7, ruleId: "foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("keeps problems on a previous line before the comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 1, column: 10, ruleId: "foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("filters problems at the same location as the comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 1, column: 8, ruleId: null, suppressions: [{ kind: "directive", justification: "justification" }] }] }
            );
        });
        ...
        it("filters out problems after the comment on the same line", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 1, column: 10, ruleId: "foo", suppressions: [{ kind: "directive", justification: "justification" }] }] }
            );
        });
        ...
        it("filters out problems on a later line than the comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 2, column: 3, ruleId: "foo", suppressions: [{ kind: "directive", justification: "justification" }] }] }
            );
        });
    });
    ...
    describe("/* eslint-disable */ comments with rules", () => {
        ...
        it("filters problems in the same location as the comment that have the same ruleId", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 1, column: 8, ruleId: "foo", suppressions: [{ kind: "directive", justification: "justification" }] }] }
            );
        });
        ...
        it("keeps problems after the comment that have a different ruleId", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 2, column: 3, ruleId: "not-foo" }], suppressedMessages: [] }
            );
        });
    ...
    describe("eslint-enable comments without rules", () => {
        it("keeps problems after the eslint-enable comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 1, column: 27, ruleId: "foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("keeps problems in the same location as the eslint-enable comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 1, column: 26, ruleId: "foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("filters out problems before the eslint-enable comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 1, column: 3, ruleId: "foo", suppressions: [{ kind: "directive", justification: "j1" }] }] }
            );
        });
        ...
        it("filter out problems if disable all then enable foo and then disable foo", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 3, column: 3, ruleId: "foo", suppressions: [{ kind: "directive", justification: "j3" }] }] }
            );
        });
        ...
        it("keeps problems before the eslint-enable comment if there is no corresponding disable comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 1, column: 3, ruleId: "not-foo" }], suppressedMessages: [] }
            );
        });
    });
    ...
    describe("eslint-enable comments with rules", () => {
        it("keeps problems after the comment that have the same ruleId as the eslint-enable comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 2, column: 4, ruleId: "foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("keeps problems in the same location as the comment that have the same ruleId as the eslint-enable comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 2, column: 1, ruleId: "foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("filters problems after the comment that have a different ruleId as the eslint-enable comment", () => {
            assert.deepStrictEqual(
                applyDisableDirectives({
                    directives: [
                        { type: "disable", line: 1, column: 1, ruleId: null, justification: "j1" },
                        { type: "enable", line: 2, column: 1, ruleId: "foo", justification: "j2" }
                    ],
                    problems: [{ line: 2, column: 4, ruleId: "not-foo" }]
                }),
                { messages: [], suppressedMessages: [{ line: 2, column: 4, ruleId: "not-foo", suppressions: [{ kind: "directive", justification: "j1" }] }] }
            );
        });
    ...
    describe("eslint-disable-line comments without rules", () => {
        it("keeps problems on a previous line", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 1, column: 5, ruleId: "foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("filters problems before the comment on the same line", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 1, column: 1, ruleId: "foo", suppressions: [{ kind: "directive", justification: "justification" }] }] }
            );
        });
    ...
    describe("eslint-disable-line comments with rules", () => {
        it("filters problems on the current line that match the ruleId", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 1, column: 2, ruleId: "foo", suppressions: [{ kind: "directive", justification: "justification" }] }] }
            );
        });
        ...
        it("keeps problems on the current line that do not match the ruleId", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 1, column: 2, ruleId: "not-foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("filters problems on the current line that do not match the ruleId if preceded by a disable comment", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 1, column: 5, ruleId: "not-foo", suppressions: [{ kind: "directive", justification: "j1" }] }] }
            );
        });
        ...
        it("handles consecutive comments appropriately", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 2, column: 1, ruleId: "foo", suppressions: [{ kind: "directive", justification: "j2" }] }] }
            );
        });
    });
    ...
    describe("eslint-disable-next-line comments without rules", () => {
        ...
        it("keeps problems on the same line", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 1, column: 3, ruleId: "foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("keeps problems after the next line", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 3, column: 3, ruleId: "foo" }], suppressedMessages: [] }
            );
        });
        ...
        it("filters problems on the next line even if there is an eslint-enable comment on the same line", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 2, column: 2, ruleId: "foo", suppressions: [{ kind: "directive", justification: "j1" }] }] }
            );
        });
    });
    ...
    describe("eslint-disable-next-line comments with rules", () => {
        it("filters problems on the next line that match the ruleId", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 2, column: 1, ruleId: "foo", suppressions: [{ kind: "directive", justification: "justification" }] }] }
            );
        });
        ...
        it("keeps problems on the next line that do not match the ruleId", () => {
            assert.deepStrictEqual(
                ...
                { messages: [{ line: 2, column: 1, ruleId: "not-foo" }], suppressedMessages: [] }
            );
        });
    });
    ...
    describe("unused directives", () => {
        ...
        it("Does not add a problem for /* eslint-disable foo */ /* (problem from foo) */", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 1, column: 6, ruleId: "foo", suppressions: [{ kind: "directive", justification: "justification" }] }] }
            );
        });
        ...
        it("Does not add a problem for // eslint-disable-next-line \\n (problem)", () => {
            assert.deepStrictEqual(
                ...
                { messages: [], suppressedMessages: [{ line: 2, column: 10, ruleId: "foo", suppressions: [{ kind: "directive", justification: "justification" }] }] }
            );
        });
