...
ruleTester.run("no-warning-comments", rule, {
    ...
    invalid: [
        ...
        },
        {
            ...
            options: [{ location: "anywhere" }],
            errors: [
                { messageId: "unexpectedComment", data: { type: "todo", comment: "'any block comment with TODO, FIXME...'" } },
                { messageId: "unexpectedComment", data: { type: "fixme", comment: "'any block comment with TODO, FIXME...'" } },
                { messageId: "unexpectedComment", data: { type: "xxx", comment: "'any block comment with TODO, FIXME...'" } }
            ]
        },
        {
        ...
        },
        {
            ...
            options: [{ location: "anywhere" }],
            errors: [
                { messageId: "unexpectedComment", data: { type: "todo", comment: "'TODO: something really longer than...'" } }
            ]
        },
        {
            code:
            ...
            errors: [
                {
                    ...
                    data: {
                        type: "todo",
                        comment: "'TODO: something   really longer than...'"
                    }
                }
            ]
        },
