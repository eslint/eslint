...
ruleTester.run("eqeqeq", rule, {
    ...
    invalid: [
        ...
        { code: "true == undefined", options: ["always", { undefined: "always" }], errors: [{ messageId: "unexpected", data: wantedEqEqEq, type: "BinaryExpression" }] },
        { code: "true != undefined", options: ["always", { undefined: "always" }], errors: [{ messageId: "unexpected", data: wantedNotEqEq, type: "BinaryExpression" }] },
        { code: "undefined == undefined", options: ["always", { undefined: "always" }], errors: [{ messageId: "unexpected", data: wantedEqEqEq, type: "BinaryExpression" }] },
        { code: "undefined != undefined", options: ["always", { undefined: "always" }], errors: [{ messageId: "unexpected", data: wantedNotEqEq, type: "BinaryExpression" }] },
        { code: "true === undefined", options: ["always", { undefined: "never" }], errors: [{ messageId: "unexpected", data: wantedEqEq, type: "BinaryExpression" }] },
        { code: "true !== undefined", options: ["always", { undefined: "never" }], errors: [{ messageId: "unexpected", data: wantedNotEq, type: "BinaryExpression" }] },
        { code: "undefined === undefined", options: ["always", { undefined: "never" }], errors: [{ messageId: "unexpected", data: wantedEqEq, type: "BinaryExpression" }] },
        { code: "undefined !== undefined", options: ["always", { undefined: "never" }], errors: [{ messageId: "unexpected", data: wantedNotEq, type: "BinaryExpression" }] },
