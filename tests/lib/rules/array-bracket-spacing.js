...
ruleTester.run("array-bracket-spacing", rule, {
    ...
    valid: [
        ...
        { code: "([ a, b ]: Array<any>) => {}", options: ["always"], parser: parser("flow-destructuring-1"), languageOptions: { ecmaVersion: 6 } },
        { code: "([a, b]: Array< any >) => {}", options: ["never"], parser: parser("flow-destructuring-2"), languageOptions: { ecmaVersion: 6 } }
    ],
