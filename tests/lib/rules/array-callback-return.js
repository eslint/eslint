...
ruleTester.run("array-callback-return", rule, {
    valid: [
        ...
        "foo[every](function() {})",
        "var every = function() {}",
        {code: "foo[`${every}`](function() {})", ecmaFeatures: {templateStrings: true}},
        {code: "foo.every(() => true)", ecmaFeatures: {arrowFunctions: true}},
        {code: "foo.every(() => { return true; })", ecmaFeatures: {arrowFunctions: true}},
    ...
    invalid: [
        ...
        {code: "foo[\"every\"](function() {})", errors: ["Expected to return a value in this function."]},
        {code: "foo[`every`](function() {})", ecmaFeatures: {templateStrings: true}, errors: ["Expected to return a value in this function."]},
        {code: "foo.every(() => {})", ecmaFeatures: {arrowFunctions: true}, errors: [{message: "Expected to return a value in this function.", column: 14}]},
