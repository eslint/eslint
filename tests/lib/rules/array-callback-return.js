...
ruleTester.run("array-callback-return", rule, {
    valid: [
        ...
        { code: "foo.flatMap(function() { return true; })", parserOptions: { ecmaVersion: 2019 } },
        ...
        { code: "foo.flatMap(function() { return; })", options: allowImplicitOptions, parserOptions: { ecmaVersion: 2019 } },
        ...
        "foo._every(function() {})",
        { code: "foo._every(function() {})", parserOptions: { ecmaVersion: 2019 } },
        "foo.every_(function() {})",
        { code: "foo.every_(function() {})", parserOptions: { ecmaVersion: 2019 } },
        "foo._reduceRight(function() {})",
        { code: "foo._reduceRight(function() {})", parserOptions: { ecmaVersion: 2019 } },
        "foo.reduceRight_(function() {})",
        { code: "foo.reduceRight_(function() {})", parserOptions: { ecmaVersion: 2019 } },
        "foo._sort(function() {})",
        { code: "foo._sort(function() {})", parserOptions: { ecmaVersion: 2019 } },
        "foo.sort_(function() {})",
        { code: "foo.sort_(function() {})", parserOptions: { ecmaVersion: 2019 } },
        { code: "foo._flatMap(function() {})", parserOptions: { ecmaVersion: 2019 } },
        { code: "foo.flatMap_(function() {})", parserOptions: { ecmaVersion: 2019 } },
        ...
        // flatMap is reported only for ecmaVersion >= 2019
        "foo.flatMap(function() { })",
        { code: "foo.flatMap(function() { })", parserOptions: { ecmaVersion: 6 } },
        { code: "foo.flatMap(function() { })", parserOptions: { ecmaVersion: 2016 } },
        { code: "foo.flatMap(function() { })", parserOptions: { ecmaVersion: 2017 } },
        { code: "foo.flatMap(function() { })", parserOptions: { ecmaVersion: 2018 } }
    ],
    invalid: [
        ...
        { code: "foo.every(function() {})", parserOptions: { ecmaVersion: 2019 }, errors: [{ messageId: "expectedInside", data: { name: "function" } }] },
        { code: "foo.every(function foo() {})", errors: [{ messageId: "expectedInside", data: { name: "function 'foo'" } }] },
        { code: "foo.every(function foo() {})", parserOptions: { ecmaVersion: 2019 }, errors: [{ messageId: "expectedInside", data: { name: "function 'foo'" } }] },
        ...
        { code: "foo.flatMap(function() {})", parserOptions: { ecmaVersion: 2019 }, errors: [{ messageId: "expectedInside", data: { name: "function" } }] },
        { code: "foo.flatMap(function() {})", parserOptions: { ecmaVersion: 2020 }, errors: [{ messageId: "expectedInside", data: { name: "function" } }] },
        { code: "foo.flatMap(function foo() {})", parserOptions: { ecmaVersion: 2019 }, errors: [{ messageId: "expectedInside", data: { name: "function 'foo'" } }] },
        { code: "foo.flatMap(function foo() {})", parserOptions: { ecmaVersion: 2020 }, errors: [{ messageId: "expectedInside", data: { name: "function 'foo'" } }] },
        ...
        { code: "foo.reduceRight(function() {})", parserOptions: { ecmaVersion: 2019 }, errors: [{ messageId: "expectedInside", data: { name: "function" } }] },
        { code: "foo.reduceRight(function foo() {})", errors: [{ messageId: "expectedInside", data: { name: "function 'foo'" } }] },
        { code: "foo.reduceRight(function foo() {})", parserOptions: { ecmaVersion: 2019 }, errors: [{ messageId: "expectedInside", data: { name: "function 'foo'" } }] },
        ...
        { code: "foo.sort(function() {})", parserOptions: { ecmaVersion: 2019 }, errors: [{ messageId: "expectedInside", data: { name: "function" } }] },
        { code: "foo.sort(function foo() {})", errors: [{ messageId: "expectedInside", data: { name: "function 'foo'" } }] },
        { code: "foo.sort(function foo() {})", parserOptions: { ecmaVersion: 2019 }, errors: [{ messageId: "expectedInside", data: { name: "function 'foo'" } }] },
