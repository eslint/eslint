...
ruleTester.run("no-unused-labels", rule, {
	...
	invalid: [
		...
		},
		{
			...
			output: null,
			errors: [{ messageId: "unused", data: { name: "foo" } }],
		},
		{
		...
		},
		{
			code: "if (foo) { bar: 'baz' }",
			output: "if (foo) { 'baz' }",
			errors: [{ messageId: "unused", data: { name: "bar" } }],
		},
		{
			code: "A: B: 'foo'",
			output: "B: 'foo'",
			errors: [
				{ messageId: "unused", data: { name: "A" } },
				{ messageId: "unused", data: { name: "B" } },
			],
		},
		{
			code: "A: B: C: 'foo'",
