...
eslintTester.addRuleTest("lib/rules/sort-vars", {
    valid: [
        ...
        { code: "var {A, b, C};", args: ignoreCaseArgs,
            ecmaFeatures: { destructuring: true }},
        { code: "var test = [1,2,3];", args: ignoreCaseArgs,
            ecmaFeatures: { destructuring: true }},
        ...
        { code: "var [a, {x: {b, c}}] = {};", args: ignoreCaseArgs,
            ecmaFeatures: { destructuring: true }},
        { code: "var a = 42, {b, c } = {};", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }},
        { code: "var {a, b, c: {c, d: d}, e: [e,f]} = {};", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }},
        { code: "var [a, b, {c: {c, d: d}}, {e: [e,f]}] = [];", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }}
    ...
    invalid: [
        ...
        { code: "var {b, c, a};", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }},
        { code: "let {b, c, a};", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { blockBindings: true, destructuring: true }},
        { code: "const {b, c, a} = {a: 1, b:true, c: \"Moo\"};", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { blockBindings: true, destructuring: true }},
        { code: "var {b, c, a};", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { blockBindings: true, destructuring: true }},
        { code: "var {b, x: {a, c}} = [];", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }},
        { code: "var [b, {a, c}] = {};", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }},
        { code: "var {b, x: [a, c]} = {};", args: ignoreCaseArgs, errors: [ expectedError ],
        ...
        { code: "var [b, {x: a, c}] = {};", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }},
        { code: "var b = 42, { a, c } = obj", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }},
        { code: "var {a, b, c: {c, d: e}, e: [d,f]} = {};", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }},
        { code: "var [a, b, {c: {c, d: e}}, {e: [d,f]}] = [];", args: ignoreCaseArgs, errors: [ expectedError ],
            ecmaFeatures: { destructuring: true }}
