...
ruleTester.run("no-constant-binary-expression", rule, {
    ...
    invalid: [
        ...
        { code: "x === new Promise()", errors: [{ messageId: "alwaysNew" }], languageOptions: { ecmaVersion: 6 } },
        { code: "x === new WeakSet()", errors: [{ messageId: "alwaysNew" }], languageOptions: { ecmaVersion: 6 } },
