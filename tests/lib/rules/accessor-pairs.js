...
ruleTester.run("accessor-pairs", rule, {
    ...
    invalid: [
        ...
        // Reports just the Property node, not the whole literal
        {
            code: "var o = { get a() {} };",
            options: [{ setWithoutGet: true, getWithoutSet: true }],
            errors: [{ messageId: "setter", type: "Property" }]
        },
        {
            code: "var o = { set a(foo) {} };",
            options: [{ setWithoutGet: true, getWithoutSet: true }],
            errors: [{ messageId: "getter", type: "Property" }]
        },
        ...
        // Different keys
        {
            ...
            options: [{ setWithoutGet: true, getWithoutSet: true }],
            errors: [setterError, getterError]
        },
        {
            code: "var o = { set a(foo) {}, get b() {} };",
            options: [{ setWithoutGet: true, getWithoutSet: true }],
            errors: [getterError, setterError]
        },
        {
        ...
        },
        {
            ...
            options: [{ setWithoutGet: true, getWithoutSet: true }],
            errors: [getterError, getterError]
        },
        {
            code: "var o = { get a() {}, set b(foo) {}, set c(foo) {}, get d() {} };",
            options: [{ setWithoutGet: true, getWithoutSet: true }],
            errors: [setterError, getterError, getterError, setterError]
        },
