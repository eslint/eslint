 ...
 * @param {int} [endColumn] end line column number
 * @returns {Object} Error object
 */
function errorAt(line, column, endLine = null, endColumn = null) {
    const error = {
...
ruleTester.run("one-var-declaration-per-line", rule, {
    ...
    invalid: [
        { code: "var foo, bar;", output: "var foo, \nbar;", options: ["always"], errors: [errorAt(1, 10, 1, 13)] },
        ...
        { code: "var foo, bar, baz = 0;", output: "var foo, bar, \nbaz = 0;", options: ["initializations"], errors: [errorAt(1, 15, 1, 22)] },
