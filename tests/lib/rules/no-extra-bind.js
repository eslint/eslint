...
eslintTester.addRuleTest("lib/rules/no-extra-bind", {
    valid: [
        ...
        { code: "var a = (() => { return b }).bind(c, d)", settings: { ecmascript: 6 } }
    ],
    invalid: [
        { code: "var a = function() { return 1; }.bind(b)", errors: [{ message: "The function binding is unnecessary.", type: "CallExpression"}] },
        { code: "var a = (() => { return 1; }).bind(b)", settings: { ecmascript: 6 }, errors: [{ message: "The function binding is unnecessary.", type: "CallExpression"}] },
