...
ruleTester.run("prefer-exponentiation-operator", rule, {
    ...
    invalid: [
        ...
        // https://github.com/eslint/eslint/issues/17173
        {
            ...
            languageOptions: {
                parser: require(
                    parser("typescript-parsers/exponentiation-with-assertion-1")
                )
            },
            errors: [
                {
        ...
        },
        {
            ...
            languageOptions: {
                parser: require(
                    parser("typescript-parsers/exponentiation-with-assertion-2")
                )
            },
            errors: [
                {
        ...
        },
        {
            ...
            languageOptions: {
                parser: require(
                    parser("typescript-parsers/exponentiation-with-assertion-3")
                )
            },
            errors: [
                {
