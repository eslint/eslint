...
ruleTester.run("max-statements-per-line", rule, {
    ...
    invalid: [
        ...
        { code: "var foo = { prop: () => { var bar = 1; } };", options: [{ max: 1 }], errors: [{ messageId: "exceed" }], languageOptions: { ecmaVersion: 6 } },
        ...
        { code: "var foo = { prop: () => { var bar = 1; var baz = 2; } };", options: [{ max: 2 }], errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 3, statements: "statements", maxStatementsPerLine: 2.0 } }], languageOptions: { ecmaVersion: 6 } },
        ...
        { code: "let bar = bar => { a; }, baz = baz => { b; }, qux = qux => { c; };", options: [{ max: 3 }], errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 4, statements: "statements", maxStatementsPerLine: 3.0 } }], languageOptions: { ecmaVersion: 6 } },
        { code: "(bar => { a; }) ? (baz => { b; }) : (qux => { c; });", options: [{ max: 3 }], errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 4, statements: "statements", maxStatementsPerLine: 3.0 } }], languageOptions: { ecmaVersion: 6 } },
        { code: "bar => { a; }, baz => { b; }, qux => { c; }, quux => { d; };", options: [{ max: 4 }], errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 5, statements: "statements", maxStatementsPerLine: 4.0 } }], languageOptions: { ecmaVersion: 6 } },
        { code: "[bar => { a; }, baz => { b; }, qux => { c; }, quux => { d; }];", options: [{ max: 4 }], errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 5, statements: "statements", maxStatementsPerLine: 4.0 } }], languageOptions: { ecmaVersion: 6 } },
        { code: "foo(bar => { a; }, baz => { b; }, qux => { c; }, quux => { d; });", options: [{ max: 4 }], errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 5, statements: "statements", maxStatementsPerLine: 4.0 } }], languageOptions: { ecmaVersion: 6 } },
        { code: "({ bar: bar => { a; }, baz: baz => { b; }, qux: qux => { c; }, quux: quux => { d; }});", options: [{ max: 4 }], errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 5, statements: "statements", maxStatementsPerLine: 4.0 } }], languageOptions: { ecmaVersion: 6 } },
        ...
        { code: "export default function foo() { console.log('test') }", options: [{ max: 1 }], errors: [{ messageId: "exceed" }], languageOptions: { ecmaVersion: 6, sourceType: "module" } },
        { code: "export function foo() { console.log('test') }", options: [{ max: 1 }], errors: [{ messageId: "exceed" }], languageOptions: { ecmaVersion: 6, sourceType: "module" } }
    ]
});
