...
ruleTester.run("max-statements-per-line", rule, {
    valid: [
        ...
        { code: "var foo = { prop: () => { } };", options: [{ max: 1 }], languageOptions: { ecmaVersion: 6 } },
        ...
        { code: "var foo = function foo() {\nvar bar = 1; var baz = 2;\n};", options: [{ max: 2 }] },
        { code: "var foo = { prop: () => { var bar = 1; } };", options: [{ max: 2 }], languageOptions: { ecmaVersion: 6 } },
        ...
        { code: "let bar = bar => { a; }, baz = baz => { b; };", options: [{ max: 3 }], languageOptions: { ecmaVersion: 6 } },
        { code: "function foo({[bar => { a; }]: baz = qux => { b; }}) { }", options: [{ max: 3 }], languageOptions: { ecmaVersion: 6 } },
        { code: "bar => { a; }, baz => { b; }, qux => { c; };", options: [{ max: 4 }], languageOptions: { ecmaVersion: 6 } },
        { code: "[bar => { a; }, baz => { b; }, qux => { c; }];", options: [{ max: 4 }], languageOptions: { ecmaVersion: 6 } },
        { code: "foo(bar => { a; }, baz => { c; }, qux => { c; });", options: [{ max: 4 }], languageOptions: { ecmaVersion: 6 } },
        { code: "({ bar: bar => { a; }, baz: baz => { c; }, qux: qux => { ; }});", options: [{ max: 4 }], languageOptions: { ecmaVersion: 6 } },
        { code: "(bar => { a; }) ? (baz => { b; }) : (qux => { c; });", options: [{ max: 4 }], languageOptions: { ecmaVersion: 6 } },
        {
            code: [
                "const name = 'ESLint'",
    ...
    invalid: [
        ...
        { code: "var foo = { prop: () => { var bar = 1; } };", options: [{ max: 1 }], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "exceed" }] },
        ...
        { code: "var foo = { prop: () => { var bar = 1; var baz = 2; } };", options: [{ max: 2 }], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 3, statements: "statements", maxStatementsPerLine: 2.0 } }] },
        ...
        { code: "let bar = bar => { a; }, baz = baz => { b; }, qux = qux => { c; };", options: [{ max: 3 }], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 4, statements: "statements", maxStatementsPerLine: 3.0 } }] },
        { code: "(bar => { a; }) ? (baz => { b; }) : (qux => { c; });", options: [{ max: 3 }], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 4, statements: "statements", maxStatementsPerLine: 3.0 } }] },
        { code: "bar => { a; }, baz => { b; }, qux => { c; }, quux => { d; };", options: [{ max: 4 }], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 5, statements: "statements", maxStatementsPerLine: 4.0 } }] },
        { code: "[bar => { a; }, baz => { b; }, qux => { c; }, quux => { d; }];", options: [{ max: 4 }], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 5, statements: "statements", maxStatementsPerLine: 4.0 } }] },
        { code: "foo(bar => { a; }, baz => { b; }, qux => { c; }, quux => { d; });", options: [{ max: 4 }], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 5, statements: "statements", maxStatementsPerLine: 4.0 } }] },
        { code: "({ bar: bar => { a; }, baz: baz => { b; }, qux: qux => { c; }, quux: quux => { d; }});", options: [{ max: 4 }], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "exceed", data: { numberOfStatementsOnThisLine: 5, statements: "statements", maxStatementsPerLine: 4.0 } }] },
        ...
        { code: "export default function foo() { console.log('test') }", options: [{ max: 1 }], languageOptions: { ecmaVersion: 6, sourceType: "module" }, errors: [{ messageId: "exceed" }] },
        { code: "export function foo() { console.log('test') }", options: [{ max: 1 }], languageOptions: { ecmaVersion: 6, sourceType: "module" }, errors: [{ messageId: "exceed" }] }
    ]
});
