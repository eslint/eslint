...
eslintTester.addRuleTest("lib/rules/semi", {
    ...
    invalid: [
        ...
        { code: "let x = 5", settings: { ecmascript: 6 }, errors: [{ message: "Missing semicolon.", type: "VariableDeclaration"}] },
        { code: "const x = 5", settings: { ecmascript: 6 }, errors: [{ message: "Missing semicolon.", type: "VariableDeclaration"}] },
        ...
        { code: "let x = 5;", args: [1, "never"], settings: { ecmascript: 6 }, errors: [{ message: "Extra semicolon.", type: "VariableDeclaration"}] },
