...
ruleTester.run("no-unused-vars", rule, {
    valid: [
        ...
        { code: "function foo() {var foo = 1; return foo}; foo();", parserOptions: { ecmaVersion: 6 } },
        { code: "function foo(foo) {return foo}; foo(1);", parserOptions: { ecmaVersion: 6 } },
        { code: "function foo() {function foo() {return 1;}; return foo()}; foo();", parserOptions: { ecmaVersion: 6  } },
