...
ruleTester.run("no-unused-vars", rule, {
    valid: [
        ...
        { code: "const [a, b] = [1, 2]; b;", options: [{ vars: "all", ignoreAfterSiblingUsed: true }], parserOptions: { ecmaVersion: 2018 } },
    ...
    invalid: [
        ...
        { code: "const [a, b] = [1, 2]; b;", options: [{ vars: "all" }], parserOptions: { ecmaVersion: 2018 }, errors: [assignedError("a")] },
        { code: "let a, b; [a, b] = [1, 2]; b;", options: [{ vars: "all", ignoreAfterSiblingUsed: true }], parserOptions: { ecmaVersion: 2018 }, errors: [assignedError("a")] },
