...
eslintTester.addRuleTest("lib/rules/max-params", {
    valid: [
        ...
        { code: "var test = (a, b, c) => {};", args: [1, 3], settings: { ecmascript: 6} },
    ...
    invalid: [
        ...
        { code: "var test = (a, b, c, d) => {};", args: [1, 3], settings: { ecmascript: 6 }, errors: [{ message: "This function has too many parameters (4). Maximum allowed is 3.", type: "ArrowFunctionExpression"}] },
