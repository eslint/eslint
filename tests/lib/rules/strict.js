...
const es5 = { languageOptions: { ecmaVersion: 5, sourceType: "script" } };
...
ruleTester.run("strict", rule, {
    valid: [
        ...
        // "never" mode
        { code: "foo();", options: ["never"], ...es5 },
        { code: "function foo() { return; }", options: ["never"], ...es5 },
        { code: "var foo = function() { return; };", options: ["never"], ...es5 },
        { code: "foo(); 'use strict';", options: ["never"], ...es5 },
        { code: "function foo() { bar(); 'use strict'; return; }", options: ["never"], ...es5 },
        { code: "var foo = function() { { 'use strict'; } return; };", options: ["never"], ...es5 },
        { code: "(function() { bar('use strict'); return; }());", options: ["never"], ...es5 },
        ...
        { code: "function foo() { return; }", options: ["never"], languageOptions: { ecmaFeatures: { impliedStrict: true } } },
        ...
        { code: "function foo() { return; }", options: ["global"], languageOptions: { ecmaFeatures: { impliedStrict: true } } },
        ...
        { code: "function foo() { return; }", options: ["function"], languageOptions: { ecmaFeatures: { impliedStrict: true } } },
        ...
        { code: "'use strict'; function foo() { return; }", options: ["safe"], languageOptions: { ecmaFeatures: { globalReturn: true } } },
        { code: "function foo() { return; }", options: ["safe"], languageOptions: { ecmaVersion: 6, sourceType: "module" } },
        { code: "function foo() { return; }", options: ["safe"], languageOptions: { ecmaFeatures: { impliedStrict: true } } },

        // defaults to "safe" mode
        "function foo() { 'use strict'; return; }",
        { code: "'use strict'; function foo() { return; }", languageOptions: { ecmaFeatures: { globalReturn: true } } },
        { code: "function foo() { return; }", languageOptions: { ecmaVersion: 6, sourceType: "module" } },
        { code: "function foo() { return; }", languageOptions: { ecmaFeatures: { impliedStrict: true } } },
        ...
        { code: "class C { static { 'use strict'; } }", options: ["safe"], languageOptions: { ecmaVersion: 2022, ecmaFeatures: { impliedStrict: true } } },
        {
    ...
    invalid: [
        ...
        // "never" mode
        {
            ...
            options: ["never"],
            languageOptions: { ecmaFeatures: { impliedStrict: true } },
            errors: [
            ...
            output: " function foo() {  return; }",
            options: ["never"],
            languageOptions: { ecmaVersion: 6, sourceType: "module", ecmaFeatures: { impliedStrict: true } },
            errors: [
                { messageId: "module", type: "ExpressionStatement" },
                { messageId: "module", type: "ExpressionStatement" }
            ]
        ...
        },
        {
            ...
            output: "class C { static { function foo() { \n } } }",
            options: ["safe"],
            languageOptions: { ecmaVersion: 2022, ecmaFeatures: { impliedStrict: true } },
