...
ruleTester.run("comma-spacing", rule, {
    valid: [
        ...
        { code: "<a>,</a>", languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } } },
        { code: "<a>  ,  </a>", languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } } },
        { code: "<a>Hello, world</a>", options: [{ before: true, after: false }], languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } } },
    ...
    invalid: [
        ...
        },
        {
            code: "<a>{foo(1 ,2)}</a>",
            output: "<a>{foo(1, 2)}</a>",
            languageOptions: { ecmaVersion: 6, ecmaFeatures: { jsx: true } },
            errors: [
                {
                    message: "There should be no space before ','.",
                    type: "Punctuator"
