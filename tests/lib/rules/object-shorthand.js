    ...
    invalid: [
        {
            code: "var x = {x: x}",
            parserOptions: { ecmaVersion: 6 },
            errors: [{ message: "Expected property shorthand.", type: "Property" }],
            output: "var x = {x}"
        },
        {
            code: "var x = {'x': x}",
        ...
        },
        {
            ...
            parserOptions: { ecmaVersion: 6 },
            errors: [{ message: "Expected method shorthand.", type: "Property" }],
            output: "var x = {y() {}}"
        },
        {
            code: "var x = {y: function*() {}}",
        ...
        },
        {
            code: "var x = {y() {}}",
            parserOptions: { ecmaVersion: 6 },
            errors: [{ message: "Expected longform method syntax.", type: "Property" }],
            options: ["never"]
        },
        {
            code: "var x = {*y() {}}",
        ...
        },
        {
            code: "var x = {y}",
            parserOptions: { ecmaVersion: 6 },
            errors: [{ message: "Expected longform property syntax.", type: "Property" }],
            options: ["never"]
        },
        {
            code: "var x = {y, a: b, *x(){}}",
