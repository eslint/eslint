...
ruleTester.run("max-statements", rule, {
    valid: [
        ...
        { code: "var foo = { thing() { var bar = 1; var baz = 2; } }", options: [2], languageOptions: { ecmaVersion: 6 } },
        { code: "var foo = { ['thing']() { var bar = 1; var baz = 2; } }", options: [2], languageOptions: { ecmaVersion: 6 } },
        { code: "var foo = { thing: () => { var bar = 1; var baz = 2; } }", options: [2], languageOptions: { ecmaVersion: 6 } },
        ...
        { code: "class C { static { one; two; three; { four; five; six; } } }", options: [2], languageOptions: { ecmaVersion: 2022 } },
        { code: "function foo() { class C { static { one; two; three; { four; five; six; } } } }", options: [2], languageOptions: { ecmaVersion: 2022 } },
        { code: "class C { static { one; two; three; function foo() { 1; 2; } four; five; six; } }", options: [2], languageOptions: { ecmaVersion: 2022 } },
        { code: "class C { static { { one; two; three; function foo() { 1; 2; } four; five; six; } } }", options: [2], languageOptions: { ecmaVersion: 2022 } },
        {
