...
ruleTester.run("max-statements", rule, {
    ...
    invalid: [
        ...
        { code: "var foo = () => { var bar = 1; var baz = 2; var qux = 3; };", options: [2], parserOptions: { ecmaVersion: 6 }, errors: [{ message: "Function 'anonymous' has too many statements (3). Maximum allowed is 2."}] },
        { code: "var foo = function() { var bar = 1; var baz = 2; var qux = 3; };", options: [2], errors: [{ message: "Function 'anonymous' has too many statements (3). Maximum allowed is 2."}] },
        ...
        { code: ";(function() { var bar = 1; return function () { var z; return 42; }; })()", options: [1, {ignoreTopLevelFunctions: true}], errors: [{ message: "Function 'anonymous' has too many statements (2). Maximum allowed is 1."}] },
        { code: ";(function() { var bar = 1; var baz = 2; })(); (function() { var bar = 1; var baz = 2; })()", options: [1, {ignoreTopLevelFunctions: true}], errors: [{ message: "Function 'anonymous' has too many statements (2). Maximum allowed is 1."}, { message: "Function 'anonymous' has too many statements (2). Maximum allowed is 1."}] },
        { code: "define(['foo', 'qux'], function(foo, qux) { var bar = 1; var baz = 2; return function () { var z; return 42; }; })", options: [1, {ignoreTopLevelFunctions: true}], errors: [{ message: "Function 'anonymous' has too many statements (2). Maximum allowed is 1."}] },
        ...
        // object property options
        { code: "function foo() { var bar = 1; var baz = 2; var qux = 3; }", options: [{ max: 2 }], errors: [{ message: "Function 'foo' has too many statements (3). Maximum allowed is 2."}] }
    ]
});
