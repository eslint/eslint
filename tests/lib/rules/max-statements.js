...
eslintTester.addRuleTest("lib/rules/max-statements", {
    valid: [
        ...
        { code: "var foo = { thing: () => { var bar = 1; var baz = 2; } }", args: [1, 2], settings: { ecmascript: 6 } },
    ...
    invalid: [
        ...
        { code: "var foo = () => { var bar = 1; var baz = 2; var qux = 3; };", args: [1, 2], settings: { ecmascript: 6 }, errors: [{ message: "This function has too many statements (3). Maximum allowed is 2."}] },
