...
eslintTester.addRuleTest("lib/rules/max-depth", {
    valid: [
        ...
        { code: "var foo = () => { if (true) { if (false) { if (true) { } } } }", args: [1, 3], settings: { ecmascript: 6 } },
    ...
    invalid: [
        ...
        { code: "var foo = () => { if (true) { if (false) { if (true) { } } } }", args: [1, 2], settings: { ecmascript: 6 }, errors: [{ message: "Blocks are nested too deeply (3).", type: "IfStatement"}] },
        ...
        { code: "function foo() { for (let x of foo) { if (true) {} } }", args: [1, 1], settings: { ecmascript: 6}, errors: [{ message: "Blocks are nested too deeply (2).", type: "IfStatement"}] },
