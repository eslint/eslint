...
ruleTester.run("max-depth", rule, {
    valid: [
        ...
        { code: "var foo = () => { if (true) { if (false) { if (true) { } } } }", options: [3], languageOptions: { ecmaVersion: 6 } },
        "function foo() { if (true) { if (false) { if (true) { } } } }",

        // object property options
        { code: "function foo() { if (true) { if (false) { if (true) { } } } }", options: [{ max: 3 }] },

        { code: "class C { static { if (1) { if (2) {} } } }", options: [2], languageOptions: { ecmaVersion: 2022 } },
        { code: "class C { static { if (1) { if (2) {} } if (1) { if (2) {} } } }", options: [2], languageOptions: { ecmaVersion: 2022 } },
        { code: "class C { static { if (1) { if (2) {} } } static { if (1) { if (2) {} } } }", options: [2], languageOptions: { ecmaVersion: 2022 } },
        { code: "if (1) { class C { static { if (1) { if (2) {} } } } }", options: [2], languageOptions: { ecmaVersion: 2022 } },
        { code: "function foo() { if (1) { class C { static { if (1) { if (2) {} } } } } }", options: [2], languageOptions: { ecmaVersion: 2022 } },
        {
    ...
    invalid: [
        ...
        { code: "var foo = () => { if (true) { if (false) { if (true) { } } } }", options: [2], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "tooDeeply", data: { depth: 3, maxDepth: 2 }, type: "IfStatement" }] },
        ...
        { code: "function foo() { for (let x of foo) { if (true) {} } }", options: [1], languageOptions: { ecmaVersion: 6 }, errors: [{ messageId: "tooDeeply", data: { depth: 2, maxDepth: 1 }, type: "IfStatement" }] },
