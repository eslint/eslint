...
module.exports = optionator({
    ...
    options: [
        ...
        },
        {
            ...
            type: "Int",
            description: "Maximum number of worker threads. Defaults to the number of processors."
        },
        {
            option: "threshold",
            type: "Int",
            description: "Minimum number of files for ESLint to use worker threads. Defaults to 100."
        },
        {
