 ...
 * @param {array} configInfo the configuration information to be added to the rule
 */
function RuleContext(ruleId, eslint, configInfo) {
    ...
    /**
     * The read-only configInfo of the rule
     */
     Object.defineProperty(this, "configInfo", {
        value: configInfo
     });
