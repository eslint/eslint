...
module.exports = class TokenStore {
     ...
     * @returns {Array} An array of comments indexed by their position.
     */
    ...
    /**
     * Gets all comments tokens directly after the given node or token.
     * @param {ASTNode|token} nodeOrToken The AST node or token to check for adjacent comment tokens.
     * @returns {Array} An array of comments indexed by their position.
     */
    ...
    /**
     * Gets all comments tokens inside the given node.
