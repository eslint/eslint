 ...
 * FileFinder
 * @constructor
 * @param {...string|string[]} arguments The basename(s) of the file(s) to find.
 */
function FileFinder() {
    this.fileNames = Array.prototype.reduce.call(arguments, function(a, b) {
        return a.concat(b);
    }, []);  // Flatten the list of arguments since we allow passing an array of file names too
    this.cache = {};
}
