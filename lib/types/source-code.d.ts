import { Comment, HasRange, LineColumn, Range, Token } from "./ast-common"
...
export interface SourceCode<TDefinition extends ASTDefinition> {
    readonly hasBOM: boolean
    readonly text: string
    readonly lines: readonly string[]
    readonly tokensAndComments: readonly Token[]

    readonly ast: Program<TDefinition>
    readonly parserServices: Readonly<Record<string, unknown>>
    readonly scopeManager: ScopeManager<TDefinition>
    ...
    getNodeByRangeIndex(index: number): ExtractNode<TDefinition, "Node"> | null
     ...
     * @param node - The TDefinition node.
     * @param options - The option object.
     ...
     * @param node - The TDefinition node or token.
     * @param options - The option object.
     * @returns An object representing the token.
     */
     ...
     * @param nodeOrToken The TDefinition node or token to check for adjacent comment tokens.
     ...
     * @param node The TDefinition node to get the comments for.
     * @returns An array of comments in occurrence order.
     */
    getCommentsInside(node: HasRange): Comment[]

    /**
     * @param node The TDefinition node to get JSDoc comment.
