...
class FlatRuleTester {
     ...
     */
    constructor(testerConfig = testerDefaultConfig) {
    ...
    static resetDefaultConfig() {
        sharedDefaultConfig = merge({}, testerDefaultConfig);
    }
    ...
    run(ruleName, rule, test) {
        ...
        const baseConfig = {
            plugins: {
                ...
                // copy everything but the rules over into here
                "@": {
                    parsers: {
        ...
        function runRuleForItem(item) {
            const configs = new FlatConfigArray([sharedDefaultConfig], { baseConfig });
            ...
            /*
             * TODO: Needed?
             * validate(configs, "rule-tester", id => (id === ruleName ? rule : null));
             */
