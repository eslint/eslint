...
exports.assertValidTestCase = function assertValidTestCase(
	item,
	seenTestCases,
) {
	// must have x properties
	assertString(item.code, "Test case must specify a string value for 'code'");
	 ...
	 * TODO: uncomment this when eslint v10
	 * assert.ok(
	 * 	item.errors === void 0 ||
	 * 		item.errors === 0 ||
...
exports.assertInvalidTestCase = function assertInvalidTestCase(
	item,
	seenTestCases,
	ruleName,
) {
