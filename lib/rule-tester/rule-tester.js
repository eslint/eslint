...
class RuleTester {
    ...
    constructor(testerConfig) {
         ...
         * @type {Object}
         */
        this.testerConfig = extend(

            // we have to clone because extend uses the first argument for recipient
            clone(defaultConfig),
            testerConfig,
    ...
    run(ruleName, rule, test) {
        ...
        function runRuleForItem(item) {
            ...
            if (typeof item === "string") {
                 ...
                 */
                const itemConfig = omit(item, RuleTesterParameters);
