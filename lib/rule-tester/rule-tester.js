...
class RuleTester {
    ...
    run(ruleName, rule, test) {
        ...
        function runRuleForItem(item) {
            ...
            if (hasOwnProperty(item, "before")) {
                assert.ok(typeof item.before === "function", "Optional test case property 'before' must be a function");
                item.before();
            }
        ...
        function testValidTemplate(item) {
            ...
            if (hasOwnProperty(item, "after")) {
                assert.ok(typeof item.after === "function", "Optional test case property 'after' must be a function");
                item.after();
            }
