 ...
 * @property {Function} [setup] Function to execute before testing the case.
...
class RuleTester {
    ...
    run(ruleName, rule, test) {
        ...
        function runRuleForItem(item) {
            ...
            if (hasOwnProperty(item, "setup")) {
                assert.ok(typeof item.setup === "function", "Optional test case property 'setup' must be a function");
                item.setup();
            }
