				...
				for (let i = 0, l = item.errors.length; i < l; i++) {
					...
					if (typeof error === "string" || error instanceof RegExp) {
						...
						assert.ok(
							...
							`Errors must use an object as the ${requireLocation ? "location properties '{ ..., line: 13, column: 42, ..}' are" : "'messageId' property '{ messageId: 'your.message' }' is"} required.`,
						);
						...
						if (hasOwnProperty(error, "column")) {
							...
							actualLocation.column = message.column;
							expectedLocation.column = "missing";
						}
						...
						if (hasOwnProperty(error, "endLine")) {
							...
							actualLocation.endLine = message.endLine;
							expectedLocation.endLine = "missing";
						}
						...
						if (hasOwnProperty(error, "endColumn")) {
							...
							actualLocation.endColumn = message.endColumn;
							expectedLocation.endColumn = "missing";
						}

						if (Object.keys(expectedLocation).length > 0) {
							const missingKeys = Object.entries(expectedLocation)
