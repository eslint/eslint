 ...
 * @param {string} configFullName The full name of the config, for use in error messages
 * @returns {Object} the config object with extends applied if present, or the passed config if not
 * @private
 */
function loadObject(configObject, configContext, configPath, configFullName) {
