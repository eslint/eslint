...
class FlatConfigArray extends ConfigArray {
	 ...
	 * @param {string} [options.basePath] The base path for the configuration.
	 * @param {boolean} [options.matchExternal=false] Whether to match files outside the base path.
	 * @param {boolean} [options.shouldIgnore=true] Whether to honor `ignores` fields.
	 * @param {FlatConfig} [options.baseConfig=defaultConfig] The base configuration to use.
	 */
	constructor(
		configs,
		{
