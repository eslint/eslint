...
/** @typedef {Omit<ConfigLoaderOptions, "warningService"> & { warningService?: WarningService }} ConfigLoaderConstructorOptions */
...
class ConfigLoader {
	 ...
	 * @param {ConfigLoaderConstructorOptions} options The options to use when loading configuration files.
	 */
	constructor(options) {
