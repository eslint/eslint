...
function getConfigForStyleGuide(guide, installESLint) {
    const config = { extends: guide };

    installModules(config, installESLint);
    ...
    return inquirer.prompt([
        ...
        },
        {
            ...
            choices: [
                ...
                { name: "type a shareable config", value: "customStyleguide" }
            ],
            when(answers) {
        ...
        {
            type: "input",
            name: "shareableConfig",
            message: "Which styleguide do you want to follow?(eslint-config-xxx)",
            when(answers) {
                return (answers.source === "guide" && answers.styleguide === "customStyleguide");
            }
        },
        {
            type: "confirm",
        ...
        if (earlyAnswers.source === "guide") {
            ...
            if (earlyAnswers.styleguide === "customStyleguide") {
                earlyAnswers.styleguide = earlyAnswers.shareableConfig;
            }
