...
/**
 * Check the local ESLint version satisfies the required version of the chosen shareable config.
 * @param {Object} answers The answers object.
...
function promptUser() {
    ...
    return inquirer.prompt([
        ...
        },
        {
            ...
            default: true,
            when(answers) {
                return answers.source === "guide" && answers.packageJsonExists && !checkLocalESLintVersion(answers);
            }
        }
    ]).then(earlyAnswers => {
