...
const { normalizeSeverity } = require("../shared/severity");
...
const severitySchema = {
    ...
    validate(value) {
        if (!(["true", "false", "error", "warn", "off", 2, 1, 0].includes(value) || typeof value === "boolean")) {
            throw new TypeError("Expected a severity string/number or boolean.");
        }
    }
};
...
const flatConfigSchema = {
    ...
    linterOptions: {
        schema: {
            ...
            reportUnusedDisableDirectives: severitySchema
        }
    },
    languageOptions: {
        schema: {
