 ...
 */
function doesRuleSupportLanguage(ruleLangs, configLanguageName, plugins) {
	...
	// Precompute once: registered plugin name → meta.namespace
	const pluginNamespaceMap = buildPluginNamespaceMap(plugins);
