...
const { getShorthandName, normalizePackageName } = require("../shared/naming");
 ...
 * @param {boolean} [usingFlatConfig=true] Indicates if flat config is being used.
