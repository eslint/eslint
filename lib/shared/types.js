 ...
 * @property {string} total The total time that is spent on (parsing, fixing, linting) a file.
 */
/**
 ...
 * @property {number} total The total time that is spent on a fix pass.
 */
