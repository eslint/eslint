...
class SourceCode extends TokenStore {
     ...
     * @param {Object|null} parserServices - The parser srevices.
     * @param {ScopeManager|null} scopeManager - The scope of this source code.
     * @param {Object|null} visitorKeys - The visitor keys to traverse AST.
     * @constructor
     */
    constructor(text, ast, parserServices, scopeManager, visitorKeys) {
        validate(ast);
         ...
         * @type {Object}
         */
        this.parserServices = parserServices || null;
