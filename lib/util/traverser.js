...
class Traverser {
    ...
    traverse(node, options) {
        ...
        try {
            ...
            if (this._context) {
                debug('Filename:', this._context.getFilename());
                debug('Parser Options:', this._context.parserOptions);
                debug('Parser Path:', this._context.parserPath);
                debug('Settings:', this._context.settings);
            }
            throw err;
        }
    }
