...
class ModuleResolver {
    ...
    resolve(name, extraLookupPath) {
        ...
        /**
         * Add all possible extra lookup path (splits `/foo/node_modules/bar/node_modules`
         * into [
         *     '/foo', '/foo/node_modules',
         *     '/foo/node_modules/bar',
         *     '/foo/node_modules/bar/node_modules'
         * ])
         */
        const extraLookupPaths = Module._nodeModulePaths(extraLookupPath); // eslint-disable-line no-underscore-dangle
         ...
         */
        const lookupPaths = this.options.lookupPaths.concat(extraLookupPaths);
