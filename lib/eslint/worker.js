...
/** @typedef {Object<string, number>} TimingData */
/**
 ...
 * @property {WorkerLintResults} results - The lint results from the worker.
 * @property {TimingData | null} timingData - The timing data from the worker.
 */
...
(async () => {
	...
	parentPort.postMessage({
		...
		timingData: timing.enabled ? timing.getData() : null,
	});
})();
