 ...
 * @property {SuppressedViolations | null} suppressions - The suppressions used to skip fixes for suppressed rules, or `null` if suppressions are not used.
 */
...
(async () => {
	/** @type {WorkerData} */
	const { eslintOptionsOrURL, filePathIndexArray, filePaths, suppressions } =
		workerData;
	const eslintOptions =
