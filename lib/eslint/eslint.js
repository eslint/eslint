...
async function loadFlatConfigFile(filePath, hasUnstableTSConfigFlag) {
    ...
    if (isTS && !isDeno && !isBun) {
        ...
        if (typeof jiti?.import !== "function") {
            throw new TypeError("You are using an outdated version of the 'jiti' library. Please update to the latest version of 'jiti' to ensure compatibility and access to the latest features.");
        }
