...
class ESLint {
    ...
    constructor(options = {}) {
        ...
        this.#configLoader = this.hasFlag("unstable_lookup_config_file_from_path")
    ...
    findConfigFile(filePath) {
        ...
        return (
            filePath
                ? this.#configLoader.findConfigFileForFile(filePath)
                : this.#configLoader.findConfigFileForDirectory(options.cwd)
        ).catch(() => void 0);
    }
