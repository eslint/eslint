...
function processOptions({
    ...
    if (unknownOptionKeys.length >= 1) {
        ...
        if (unknownOptionKeys.includes("allowInlineConfig")) {
            errors.push("'allowInlineConfig' has been removed. Please use the 'overrideConfig.noInlineConfig' option instead.");
        }
        if (unknownOptionKeys.includes("cacheFile")) {
            errors.push("'cacheFile' has been removed. Please use the 'cacheLocation' option instead.");
        }
        if (unknownOptionKeys.includes("configFile")) {
            errors.push("'configFile' has been removed. Please use the 'overrideConfig.extends' option instead.");
        }
