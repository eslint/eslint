...
function isRuntimeSupportsTS() {
     ...
     */
    // eslint-disable-next-line no-undef -- Bun and Deno are global objects in their environments
    return typeof Bun !== "undefined" || typeof Deno !== "undefined";
}
...
async function loadFlatConfigFile(filePath) {
    ...
    if (isFileTS(filePath) && !isRuntimeSupportsTS()) {
