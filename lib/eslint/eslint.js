 ...
 * @property {string} [overrideConfigFile] The configuration file to use, overrides all configs used with this instance (except `overrideConfig`)
...
function processOptions({
    ...
    ignorePath = null,
    overrideConfig = null,
    overrideConfigFile: configFile = null,
    plugins = {},
