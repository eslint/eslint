...
async function verifyText({
    ...
    const fakeFlatConfigArray = [];
    fakeFlatConfigArray.getConfig = () => config;
    ...
    const config = await configs.calculateConfigForFile(filePathToVerify);
...
class ESLint {
    ...
    /**
     * The loader for ESLint configuration files.
     * @type {ConfigLoader}
     */
    #configLoader;
    ...
    constructor(options = {}) {
        ...
        this.#configLoader = new ConfigLoader({
            ...
            configFilePath: processedOptions.configFile,
            shouldIgnore: processedOptions.ignore,
    ...
    async lintFiles(patterns) {
        ...
        const results = await Promise.all(
            ...
            filePaths.map(({ filePath, ignored }) => {
                ...
                return this.#configLoader.calculateConfigForFile(filePath).then(config => {
