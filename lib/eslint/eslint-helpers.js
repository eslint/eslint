...
function processOptions({
	...
	if (
		flags.includes("unstable_external_file_matching") &&
		overrideConfigFile === null
	) {
		errors.push(
			"When using the 'unstable_external_file_matching' flag, 'overrideConfigFile' must be provided and cannot be null.",
		);
	}
...
function createConfigLoader(
	...
	const configLoaderOptions = {
		...
		hasUnstableExternalFileMatchingFlag: linter.hasFlag(
			"unstable_external_file_matching",
		),
		warningService,
	};
