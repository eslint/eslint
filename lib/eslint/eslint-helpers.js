...
function processOptions({
	...
	if (basePath !== void 0 && !isNonEmptyString(basePath)) {
	...
	if (basePath && overrideConfigFile === null) {
		errors.push(
			"When 'basePath' is provided, 'overrideConfigFile' cannot be null.",
		);
	}
	...
	const normalizedBasePath =
		basePath && path.resolve(normalizedCwd, basePath);
