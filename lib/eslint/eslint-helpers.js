 ...
 * @param {string} filePath The absolute path to a lint target file.
 * @param {FlatConfigArray} configs The config array for the file.
 * @returns {DeprecatedRuleInfo[]} The used deprecated rule list.
 */
function getOrFindUsedDeprecatedRules(filePath, configs) {
...
async function lintFile(
	...
	async function readAndVerifyFile() {
		...
		debug('File "%s" read in %t', filePath, afterReadFile - beforeReadFile);
