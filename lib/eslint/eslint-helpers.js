    ...
    const walk = hfs.walk(
        basePath,
        {
            async directoryFilter(entry) {
                 ...
                 * traversal, we don't need to look for a config file. Otherwise,
                 * we need to check if the path is inside the parent directory.
                 */
                const shouldLoadConfigFile = isLeadingGlob && entry.depth === 1
                    ? false
                    : isPathInside(absolutePath, parent);
                 ...
                 */
                const configs = shouldLoadConfigFile
