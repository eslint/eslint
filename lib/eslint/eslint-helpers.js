 ...
 * @param {string} [filenamePrefix="cache_"] The prefix to use for the cache file
 * @returns {string} the resolved path to the cache file
 */
function getCacheFile(cacheFile, cwd, filenamePrefix) {
	/*
    ...
    const prefix = filenamePrefix || "cache_";
