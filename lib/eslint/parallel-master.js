 ...
 */
async function lintInParallel(files, cliOptions, maxConcurrency) {
    const results = [];
    ...
    log("Spawn %d workers.", numWorkers);
    await runConcurrently(numWorkers, () => new Promise((resolve, reject) => {
