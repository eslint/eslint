...
const
    ...
    {ConfigCommentParser} = require("../../../../../rewrite/packages/plugin-kit/dist/cjs/index.cjs"),
...
class SourceCode extends TokenStore {
    ...
    getInlineConfigNodes() {
        ...
        configNodes = this.ast.comments.filter(comment => {
            ...
            const directiveMatch = directivesPattern.exec(directive.label);
    ...
    getDisableDirectives() {
        ...
        this.getInlineConfigNodes().forEach(comment => {
            ...
            const match = directivesPattern.exec(label);
