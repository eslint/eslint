...
function createCursorWithSkip(factory, tokens, comments, indexMap, startLoc, endLoc, opts) {
    ...
    assert.ok(skip >= 0, "options.skip should be zero or a positive integer.");
    assert.ok(!filter || typeof filter === "function", "options.filter should be a function.");
...
function createCursorWithCount(factory, tokens, comments, indexMap, startLoc, endLoc, opts) {
    ...
    assert.ok(count >= 0, "options.count should be zero or a positive integer.");
    assert.ok(!filter || typeof filter === "function", "options.filter should be a function.");
