    ...
    run(ruleName, rule, test) {
        ...
        function runRuleForItem(ruleName, item) {
            ...
            if (typeof item === "string") {
                ...
                // Validate only config properties
                const schemaProperties = Object.keys(configSchema.properties);

                // const schemaValidator = validator(configSchema, { verbose: true });
                const itemConfig = lodash.pick(item, schemaProperties);
