                ...
                for (var i = 0, l = item.errors.length; i < l; i++) {
                    ...
                    if (typeof item.errors[i] === "string") {
                        ...
                        assert.equal(
                          messages[i].message,
                          item.errors[i],
                          "Expected error message to be: " + item.errors[i] + ", but it was " + messages[i].message
                        );
                        ...
                        if (item.errors[i].message) {
                            assert.equal(
                              messages[i].message,
                              item.errors[i].message,
                              "Expected error message to be " + item.errors[i].message + " but it was " + messages[i].message
                            );
                        }
                        ...
                        if (item.errors[i].type) {
                            assert.equal(
                              messages[i].nodeType,
                              item.errors[i].type,
                              "Expected type to be " + item.errors[i].type + " but it was " + messages[i].nodeType
                            );
                        }
                        ...
                        if (item.errors[i].hasOwnProperty("line")) {
                            assert.equal(
                              messages[i].line,
                              item.errors[i].line,
                              "Expected line to be " + item.errors[i].line + " but it was " + messages[i].line
                            );
                        }
                        ...
                        if (item.errors[i].hasOwnProperty("column")) {
                            assert.equal(
                              messages[i].column,
                              item.errors[i].column,
                              "Expected column to be " + item.errors[i].column + " but it was " + messages[i].column
                            );
                        }
                    } else {
