...
class RuleTester {
    ...
    describe(...args) { // eslint-disable-line class-methods-use-this
        return RuleTester.describe(...args);
    }

    it({ code }, fn) { // eslint-disable-line class-methods-use-this
        return RuleTester.it(code, fn);
    }
    ...
    run(ruleName, rule, test) {
         ...
         */
        this.describe(ruleName, () => {
            this.describe("valid", () => {
                test.valid.forEach(valid => {
                    this.it(typeof valid === "object" ? valid : { code: valid }, () => {
