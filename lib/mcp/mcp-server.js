...
mcpServer.tool("lint-files", "Lint files", filePathsSchema, async ({ filePaths }) => {
...
mcpServer.tool("lint-and-fix-files", "Lint and fix files", filePathsSchema, async ({ filePaths }) => {
