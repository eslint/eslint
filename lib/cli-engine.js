 ...
 * @property {number} fixableErrorCount Number or fixable errors for the result.
 * @property {number} fixableWarningCount Number or fixable warnings for the result.
