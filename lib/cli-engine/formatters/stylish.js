...
/* eslint-disable n/no-unsupported-features/node-builtins -- TODO */
...
module.exports = function (results) {
		...
		output += `${table(
			messages.map(message => {
				...
				return [
					...
					util.styleText("dim", message.ruleId || ""),
				];
			}),
			{
				align: ["", "r", "l"],
	...
	return total > 0 ? util.styleText("reset", output) : "";
};

/* eslint-enable n/no-unsupported-features/node-builtins -- TODO */
