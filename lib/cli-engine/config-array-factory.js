...
class ConfigArrayFactory {
    ...
    *_normalizeESLintIgnoreData(ignorePatterns, ctx) {
    ...
    _normalizeConfigData(configData, ctx) {
        ...
        /**
         * Cloning function using lodash.cloneDeepWith
         * @param {Object} val Object which needs to be cloned
        ...
        function cloneDeep(val) {
            ...
            /**
             * Customizer for lodash.cloneDeepWith
             * @param {Object} value value that needs to be clone with custom logic
             * @returns {Object} returns the cloned object
             */
        ...
        let clonedConfig = configData;

        try {
            clonedConfig = cloneDeep(clonedConfig);
        } catch (error) {
            debug("Failed to clone config object as it noticed some circular reference. Using the original config");
            clonedConfig = configData;
        }
