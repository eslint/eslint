...
class ConfigArrayFactory {
    ...
    *_normalizeESLintIgnoreData(ignorePatterns, ctx) {
    ...
    _normalizeConfigData(configData, ctx) {
        ...
        /**
         * Function to clone a object ref https://stackoverflow.com/a/1042676/9339537
         * @param {Object} from object which needs to be cloned
        ...
        from.constructor === String || from.constructor === Number || from.constructor === Boolean) {
            ...
            const clonedResult = new from.constructor();

            for (const name in from) {

                if (typeof clonedResult[name] === "undefined") {
                    clonedResult[name] = clone(from[name]);
                }
            }

            return clonedResult;
        }
        const clonedConfig = clone(configData);
