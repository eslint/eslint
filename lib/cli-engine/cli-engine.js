    ...
    getFormatter(format) {
        ...
        if (typeof resolvedFormatName === "string") {
            ...
            try {
                ...
                ex.message = format === "table" || format === "codeframe"
                    ? `The ${format} formatter is no longer part of core ESLint. Install it manually with \`npm install -D eslint-formatter-${format}\``
