...
/**
 * @import { DeprecatedRuleInfo, SuppressedLintMessage } from "../shared/types.js";
 * @import { ESLint, Linter as LinterType, Rule } from "eslint";
 ...
 * @property {ESLint.ConfigData} [baseConfig] Base config object, extended by all configs used with this CLIEngine instance
 ...
 * @property {LinterType.ParserOptions} [parserOptions] An object of parserOption settings to use.
 * @property {string[]} [plugins] An array of plugins to load.
 * @property {LinterType.Config['rules']} [rules] An object of rules to use.
 ...
 * @property {LinterType.LintMessage[]} messages All of the messages for the result.
 ...
 * @property {Map<string, ESLint.Plugin>} additionalPluginPool The map for additional plugins.
 ...
 * @property {LinterType} linter The linter instance which has loaded rules.
 ...
 * @param {LinterType.LintMessage[]} messages Collection of messages
 ...
 * @param {ESLint.LintResult[]} results Collection of messages from all the files
 * @returns {Object} Contains the stats
 * @private
 */
 ...
 * @param {LinterType} config.linter The linter instance to verify.
 * @returns {ESLint.LintResult} The result of linting.
 * @private
 */
function verifyText({
	text,
 ...
 * @returns {ESLint.LintResult} Result with single warning
 * @private
 */
 ...
 * @returns {Rule.RuleModule | null} The rule or null.
 */
 ...
 * @param {LinterType.LintMessage} message The message to check.
 ...
 * @returns {ESLint.ConfigData | null} The created config data.
 */
...
class CLIEngine {
	 ...
	 * @param {Record<string, ESLint.Plugin> | null} [additionalData.preloadedPlugins] Preloaded plugins.
	 */
	 ...
	 * @param {ESLint.LintResult[]} results The results to filter.
	 * @returns {ESLint.LintResult[]} The filtered results.
	 */
	 ...
	 * @returns {ESLint.ConfigData} A configuration object for the file.
	 */
	 ...
	 * @returns {(ESLint.FormatterFunction | null)} The formatter function or null if the `format` is not a string.
	 */
	getFormatter(format) {
		// default is stylish
