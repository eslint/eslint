...
class LintResultCache {
	...
	setCachedLintResults(filePath, config, result) {
		...
		if (fileDescriptor && !fileDescriptor.notFound) {
			...
			/*
			 * Serialize the result, except that we want to remove the file source and
			 * `usedDeprecatedRules` if present.
			 */
			// eslint-disable-next-line no-unused-vars -- need to remove `usedDeprecatedRules`
			const { source, usedDeprecatedRules, ...resultToSerialize } =
				result;
