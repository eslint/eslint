...
module.exports = {
    ...
    create(context) {
        ...
        const options = context.options[0] || { treatUndefinedAsUnspecified: false };
        ...
        return {
            ...
            ReturnStatement(node) {
                if (funcInfo.shouldCheck) {
                    ...
                    // if treatUndefinedAsUnspecified: false, should also check node.argument
                    if (!options.treatUndefinedAsUnspecified && !node.argument) {
                        context.report({
                            node,
