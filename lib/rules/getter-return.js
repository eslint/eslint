...
module.exports = {
    ...
    create(context) {
        ...
        const options = context.options[0] || { treatUndefinedAsSpecified: false };
        ...
        return {
            ...
            ReturnStatement(node) {
                if (funcInfo.shouldCheck) {
                    ...
                    // if treatUndefinedAsSpecified: false, should also check node.argument
                    if (!options.treatUndefinedAsSpecified && !node.argument) {
                        context.report({
                            node,
