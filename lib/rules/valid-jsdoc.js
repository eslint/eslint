...
module.exports = function(context) {
    ...
    var options = context.options[0] || {},
        ...
        requireReturnIfReturnUndefined = options.requireReturnIfReturnUndefined === false ? false : true;
    ...
    function checkJSDoc(node) {
        ...
        if (jsdocNode) {
            ...
            jsdoc.tags.forEach(function(tag) {
                ...
                switch (tag.title) {
                    ...
                    case "returns":
                        ...
                        if(requireReturnIfReturnUndefined === false && functionData.returnPresent === false
                           && tag.type.name !== "void" && tag.type.name !== "undefined") {
                            context.report(jsdocNode, "Wrong JSDoc tag, return, added to documentation. No returns found in function.");
                        } else {
                            if (!tag.type) {
            ...
            if (!hasReturns && !hasConstructor) {
                if(requireReturnIfReturnUndefined === true || functionData.returnPresent) {
