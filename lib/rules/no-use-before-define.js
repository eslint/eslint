...
/**
* Determines whether a variable reference is part of an ExportSpecifier (e.g. `export {foo};`)
* @param {escope.Reference} reference The variable reference
* @returns {boolean} true if the variable is part of an ExportSpecifier
*/
function isInExportSpecifier(reference) {
    return reference.identifier.parent.type === "ExportSpecifier";
}
    ...
    create(context) {
        ...
        function findVariablesInScope(scope) {
            scope.references.forEach(reference => {
                ...
                // - located in an ExportSpecifier
                // - allowed by options.
                if (reference.init ||
                    !variable ||
                    variable.identifiers.length === 0 ||
                    (variable.identifiers[0].range[1] < reference.identifier.range[1] && !isInInitializer(variable, reference)) ||
                    isInExportSpecifier(reference) ||
