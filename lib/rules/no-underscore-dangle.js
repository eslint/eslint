...
module.exports = {
    ...
    create(context) {
        ...
        const allowDestructured = typeof options.allowDestructured !== "undefined" ? options.allowDestructured : true;
        ...
        function deepCheckDestructured(node) {
            ...
            const identifier = node?.type === 'RestElement' ? node.argument.name : node?.type === 'Identifier' ? node?.name : null;
        ...
        function checkForDanglingUnderscoreInVariableExpression(node) {
            if (!allowDestructured && node.id?.type === 'ArrayPattern' && Array.isArray(node.id.elements)) {
