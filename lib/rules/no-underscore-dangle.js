...
module.exports = {
    ...
    create(context) {
        ...
        const ALLOWED_AFTER = options.allowAfter ? options.allowAfter : [];
        ...
        /**
         * Check if identifier is present inside the allowedAfter option
         * @param {string} identifier name of the node
         * @returns {boolean} true if its is present
         * @private
         */
        function isAllowedAfter(identifier) {
            return ALLOWED_AFTER.some(ident => ident === identifier);
        }
        ...
        function checkForDanglingUnderscoreInMemberExpression(node) {
            ...
            if (typeof identifier !== "undefined" && hasDanglingUnderscore(identifier) &&
                ...
                !isAllowedAfter(node.object.name) &&
