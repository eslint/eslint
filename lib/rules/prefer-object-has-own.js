...
function hasLeftHandObject(node) {
    ...
    if (objectPropertyName === "hasOwnProperty") {
        const childObjectPropertyName = objectPropertyName && astUtils.getStaticPropertyName(node.object.object);
        let objectNodeToCheck = node.object.object;

        if (childObjectPropertyName === "prototype") {
            objectNodeToCheck = node.object.object.object;
