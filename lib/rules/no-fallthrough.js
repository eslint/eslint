...
module.exports = {
    meta: {
        ...
        messages: {
            ...
            finalCase: "Expected a 'break' statement."
        }
    },
    ...
    create(context) {
        ...
        const checkFinalCase = options.checkFinalCase || false;
        ...
        return {
            ...
            "SwitchCase:exit"(node) {
                 ...
                 */
                const thisNodeIsReachable = currentCodePath.currentSegments.some(isReachable);
                const thisNodeIsFinalCase = node === node.parent.cases[node.parent.cases.length - 1];
                ...
                if (thisNodeIsReachable && thisNodeIsFinalCase && checkFinalCase) {
                    context.report({
                        messageId: "finalCase",
                        node
                    });
