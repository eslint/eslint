...
module.exports = function(context) {
    ...
    var options = context.options[0] || {},
        align = options.align,
        beforeColon = options.beforeColon === null ? Infinity : Number(options.beforeColon || false),  // Defaults to 0
        afterColon = options.afterColon === null ? Infinity : Number(options.afterColon || options.afterColon !== 0 && options.afterColon !== false);  // Defaults to 1
