    ...
    create(context) {
        ...
        if (firstOption) {
            if (typeof firstOption === "string") {
                ...
                config.ignoreAfterSiblingUsed = firstOption.ignoreAfterSiblingUsed || config.ignoreAfterSiblingUsed;
         ...
         * @param {Variable} variable eslint-scope variable object.
         * @returns {boolean} True if the variable has has a sibling which is an object patter, false if not.
         * @private
         */
         ...
         * used parameter.
         */
        function isAfterLastUsed(variable) {
                    ...
                    if (def) {
                        ...
                        switch (type) {
                            ...
                            case "Parameter":
                                ...
                                if (config.args === "after-used" && astUtils.isFunction(def.name.parent) && !isAfterLastUsed(variable)) {
                                    continue;
                                }
                                break;
                            default:
                                ...
                                // skip variables in array destruction with used variables to the right
                                if (config.ignoreAfterSiblingUsed && !isAfterLastUsed(variable)) {
                                    continue;
                                }
                                break;
                        }
