...
module.exports = {
    ...
    create(context) {
        ...
        function defToVariableType(def) {
            ...
            /*
             * If there is no destructuredArrayIgnorePattern, the variable is still subject to
             * the varsIgnorePattern. So, we'll fall through and consider it a normal variable.
             * TODO - this may be a bug in the rule's logic.
             */
