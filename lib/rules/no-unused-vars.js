        ...
        function handleFixes(fixer, unusedVar, writeReferences) {
            ...
            function fixVariables(node) {
                ...
                if (parentNode.type === "VariableDeclarator") {
                    ...
                    if (parentNode.parent.declarations.length === 1) {
                        ...
                        if (prevToken && !astUtils.isSemicolonToken(prevToken) && !astUtils.isOpeningBraceToken(prevToken)) {
                            return null;
                        }
            ...
            function fixNestedArrayVariable(node) {
                ...
                if (hasSingleElement(parentNode)) {
                    ...
                    // fixes { a: [{ b }] } or { a: [[ b ]] }
                    if (getTokenBeforeValue(parentNode) === ":") {
                        return fixObjectAndArrayVariable(parentNode);
                    }
            ...
            // skip fix when initialized variable is reassigned
            ...
            if (parent.parent.type === "ObjectPattern") {
                if (parent.parent.properties.length === 1) {
                     ...
                     * fix const { a: { b } } = foo;
                     */
                    return fixObjectAndArrayVariable(parent.parent);
                }
            ...
            if (parentType === "ArrayPattern") {
                if (hasSingleElement(parent)) {
                     ...
                     * fix const { a: [b] } = foo;
                     */
                    return fixObjectAndArrayVariable(parent);
                }
