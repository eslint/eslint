                                ...
                                suggest: [
                                    {
                                        ...
                                        fix(fixer) {
                                            ...
                                            if (parentType === "ImportDefaultSpecifier") {
                                                ...
                                                if (!parent.parent.specifiers.some(e => e.type === "ImportSpecifier")) {
                                                    return fixer.removeRange(parent.parent.range);
                                                }
                                            ...
                                            if (
                                                ...
                                                parent.parent.specifiers.sort(e => e.type === "ImportSpecifier").length === 1
                                            ) {
    
                                                // remove unused import when there is no default import
                                                if (!parent.parent.specifiers.some(e => e.type === "ImportDefaultSpecifier")) {
                                                    return fixer.removeRange(parent.parent.range);
                                                }
    
                                                // remove unused import when there is a default import
                                                return fixer.removeRange([getPreviousTokenStart(id, 1), tokenAfter.range[1]]);
                                            }
