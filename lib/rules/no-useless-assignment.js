...
module.exports = {
    ...
    create(context) {
        ...
        function verify(target) {
             ...
             * @returns {void}
             */
            function verifyAssignment(targetAssignment, allAssignments) {
                ...
                for (const reference of readReferences) {
                    ...
                    if (
                        ...
                        isInSegment(targetAssignment.segment, reference.identifier)
                    ) {

                        if (
                            otherAssignmentAfterTargetAssignment &&
                            otherAssignmentAfterTargetAssignment.identifier.range[0] < reference.identifier.range[0]
                        ) {
            ...
            for (const assignments of target.assignments.values()) {
                ...
                for (const assignment of assignments) {
                    verifyAssignment(assignment, assignments);
                }
            }
        }
