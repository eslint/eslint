...
module.exports = {
    ...
    create(context) {
        ...
        function checkExpressionOrExportStatement(node) {
            ...
            const thirdToken = secondToken ? sourceCode.getTokenAfter(secondToken) : {};
            ...
            if (
                ...
                (
                    ...
                    secondToken && secondToken.type === "Identifier" && secondToken.value === "async" && thirdToken.type === "Keyword" && thirdToken.value === "function"
                )
            ) {
