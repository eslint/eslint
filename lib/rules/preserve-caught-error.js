 ...
 * TODO:
 *
 * 1. [X] Detect multiple throws.
 * 2. [X] Report an error when caught error is not being looked at.
 * 3. [X] Allow passing an option for custom error types to be checked.
 * 4. [ ] Make sure we cover cases where a pre-initialized error is being thrown (stored in a variable).
 * 5. ...
 */
