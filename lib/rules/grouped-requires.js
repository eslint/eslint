/**
 * @fileoverview Rule to enforce grouped and ordered require statements for node
...
module.exports = function(context) {
    ...
    var builtin = require("repl")._builtinLibs;
    ...
    function getFirstWronglySortedDeclaration(declarations) {
        ...
        for (i = 1; i < declarations.length; i++) {
            aParts = declarations[i - 1].module.split(path.sep);
            bParts = declarations[i].module.split(path.sep);
