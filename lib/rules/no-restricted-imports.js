...
module.exports = {
    ...
    create(context) {
        ...
        const restrictedPathMessages = restrictedPaths.reduce((memo, importSource) => {
            if (typeof importSource === "string") {
                ...
                memo[importSource.name] = {
                    ...
                    excludeImportNames: importSource.excludeImportNames
                };
            }
            return memo;
        }, {});
        ...
        function checkRestrictedPathAndReport(importSource, importNames, node) {
            ...
            const excludedImportNames = restrictedPathMessages[importSource].excludeImportNames;

            if (restrictedImportNames || excludedImportNames) {
                if (importNames.has("*")) {
                ...
                /*
                * If excludeImportNames is set, restrict all names except excluded ones
                *      unless name is specifically mentioned in importNames
                */
                importNames.forEach((specifiers, importName) => {
                    let restricted = false;

                    if (excludedImportNames) {
                        if (!excludedImportNames.includes(importName)) {
                            restricted = true;
                        }
                    }
        ...
        function reportPathForPatterns(node, group, importNames) {
            ...
            const excludedImportNames = group.excludeImportNames;
