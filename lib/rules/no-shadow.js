...
module.exports = {
	...
	create(context) {
		 ...
		 * function expression in `wrap(function a() {})` or
		 * `foo || wrap(function a() {})`. The call itself may be wrapped in
		 * logical/conditional operators, but nested calls are not allowed.
