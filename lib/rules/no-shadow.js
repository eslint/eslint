...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Verifies if the given node is an init pattern node.
         *@param {ASTNode} node a node to get.
         *@returns {boolean} true if the given node is an init pattern node.
         */
        ...
        function isInitPatternNode(variable, shadowedVariable) {
            ...
            const arrowFunctionExpressionNode = findSelfOrAncestor(
                innerDef.node,
                node => node.type === "ArrowFunctionExpression"
            );

            if (arrowFunctionExpressionNode) {
                const callExpressionNode = arrowFunctionExpressionNode.parent;
                ...
                if (callExpressionNode && callExpressionNode.type === "CallExpression") {
                    ...
                    return shadowingVariableAncestor === shadowedVariableAncestor;
                }
            }
