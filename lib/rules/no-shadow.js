                ...
                if (shadowed &&
                    ...
                    if (shadowed.defs[0]) {
                        ...
                        if (
                            ...
                            if (
                                shadowedNode.start === shadowNode.parent.parent.start &&
                                shadowedNode.end === shadowNode.parent.parent.end
                            ) {
                                continue;
                            }
                        }
                        ...
                        if (
                            ...
                            shadowedNode.start === shadowNode.parent.parent.parent.parent.start &&
                            shadowedNode.end === shadowNode.parent.parent.parent.parent.end
                        ) {
                            continue;
                        }
                        if (
                            ...
                            shadowedNode.start === shadowNode.parent.parent.parent.parent.parent.start &&
                            shadowedNode.end === shadowNode.parent.parent.parent.parent.parent.end
                        ) {
                            continue;
                        }
                        ...
                        if (
                            ...
                            if (
                                shadowedNode.parent.parent.start === shadowNode.parent.parent.start &&
                                shadowedNode.parent.parent.end === shadowNode.parent.parent.end) {
                                continue;
                            }
                        }
                        ...
                        if (
                            ...
                            shadowNode.parent.parent &&
                            shadowNode.parent.parent.parent &&
                            shadowedNode.start === shadowNode.parent.parent.parent.start &&
                            shadowedNode.end === shadowNode.parent.parent.parent.end
                        ) {
                            continue;
                        }
                    }
