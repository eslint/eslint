...
module.exports = function(context) {
    ...
    var options = {
        ...
        ignore: (context.options[0] && context.options[0].ignore) || []
    };

    /**
     * Check if variable name is ignored.
     *
     * @param  {Object} variable The variable to check.
     * @returns {Boolean} Whether or not the variable name is ignored.
     */
    function isIgnored(variable) {
        return options.ignore.indexOf(variable.name) !== -1;
    }
