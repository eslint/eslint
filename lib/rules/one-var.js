...
const stringValues = ["always", "never", "consecutive"];
...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Set a value to a list of initialized declaration configurations.
         * @param {Array<string>} declarations list of declaration types
         * @param {*} value the property value
         * @returns {void}
         * @private
         */
        function setInitializedDeclarations(declarations, value) {
            declarations.forEach(declaration => {
                options[declaration].initialized = value;
            });
        }

        /**
         * Set a value to a list of unininitialized declaration configurations.
         * @param {Array<string>} declarations list of declaration types
         * @param {*} value the property value
         * @returns {void}
         * @private
         */
        function setUninitializedDeclarations(declarations, value) {
            declarations.forEach(declaration => {
                options[declaration].uninitialized = value;
            });
        }

        /**
         * Set a value to a list of declaration configurations.
         * @param {Array<string>} declarations list of declaration types
         * @param {*} value the property value
         * @returns {void}
         * @private
         */
        function setDeclarations(declarations, value) {
            if (typeof value === "string") { // declaration configuration is a string
                setUninitializedDeclarations(declarations, value);
                setInitializedDeclarations(declarations, value);
            } else if (typeof value === "object") { // declaration configuration is an object
                if (value.hasOwnProperty("uninitialized")) {
                    setUninitializedDeclarations(declarations, value.uninitialized);
                }
                if (value.hasOwnProperty("initialized")) {
                    setInitializedDeclarations(declarations, value.initialized);
                }
            }
        }

        if (typeof mode === "string") { // simple options configuration with just a string
            setDeclarations(["var", "let", "const"], mode);
        } else if (typeof mode === "object") { // options configuration is an object
            if (mode.hasOwnProperty("separateRequires")) {
                options.separateRequires = !!mode.separateRequires;
            }
            if (mode.hasOwnProperty("uninitialized")) {
                setUninitializedDeclarations(["var", "let", "const"], mode.uninitialized);
            }
            if (mode.hasOwnProperty("initialized")) {
                setInitializedDeclarations(["var", "let", "const"], mode.initialized);
            }
            if (mode.hasOwnProperty("var")) {
                setDeclarations(options, ["var"], mode.var);
            }
            if (mode.hasOwnProperty("let")) {
                setDeclarations(options, ["let"], mode.let);
            }
            if (mode.hasOwnProperty("const")) {
                setDeclarations(options, ["const"], mode.const);
            }
        }
