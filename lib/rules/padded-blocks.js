...
module.exports = {
    ...
    create(context) {
        ...
        if (typeof config === "string") {
            ...
            if (hasOwn.call(config, "blocks")) {
                options.blocks = config.blocks === "always";
            }
            if (hasOwn.call(config, "switches")) {
                options.switches = config.switches === "always";
            }
            if (hasOwn.call(config, "classes")) {
        ...
        if (hasOwn.call(options, "switches")) {
        ...
        if (hasOwn.call(options, "classes")) {
