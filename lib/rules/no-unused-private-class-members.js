...
module.exports = {
    ...
    create(context) {
         ...
         * @param {boolean} isAccessor Whether the property is declared as setter
         * @returns {boolean} Whether the node is in a write only assignment
         * @private
         */
        function isWriteOnlyAssignment(privateIdentifierNode, isAccessor) {
        ...
        return {
            ...
            PrivateIdentifier(privateIdentifierNode) {
                ...
                if (isWriteOnlyAssignment(privateIdentifierNode, memberDefinition.isAccessor)) {
                    return;
                }
