    ...
    create(context) {
        ...
        return {
            ...
            PrivateIdentifier(privateIdentifierNode) {
                const propertyDefinition = stackOfCurrentlyProcessingClassNodes[0].get(privateIdentifierNode.name);
                ...
                if (isWriteOnlyAssignmentStatementWithoutPerformingAnyReads(privateIdentifierNode, propertyDefinition.isSetter)) {
                    return;
                }
