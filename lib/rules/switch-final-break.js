...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Returns the statements list of a given switch clause
         * @param {ASTNode} node switch clause node
         * @returns {Array} - the statements list of the switch clause
         */
                    ...
                    if (requireBreak === "always") {
                        if (
                            ...
                            (lastStatement.type !== "BreakStatement" &&
                                 getStatements(lastCase).every(statement => statement.type !== "ThrowStatement" && statement.type !== "ReturnStatement"))) {
                            context.report({
                                node: lastCase,
