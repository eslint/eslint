...
module.exports = {
    ...
    create(context) {
         ...
         * @param {bool} shouldFix Whether this report should fix the node or just make a suggestion
         * @returns {void}
         */
        ...
        return {
            UnaryExpression(node) {
                ...
                if (!operatorAllowed && options.boolean && isDoubleLogicalNegating(node)) {
                    ...
                    const booleanExists = Boolean(variable?.identifiers.length === 0);

                    report(node, recommendation, booleanExists);
                }
