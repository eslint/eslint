...
const { isNullOrUndefined, isConstant, isReferenceToGlobalVariable, isLogicalAssignmentOperator } = require("./utils/ast-utils");
...
function isAlwaysNew(scope, node) {
    switch (node.type) {
        ...
        case "NewExpression": {
             ...
             */
            return Object.hasOwnProperty.call(globals.builtin, node.callee.value) &&
              isReferenceToGlobalVariable(scope, node.callee);
        }
        case "Literal":
...
function findBinaryExpressionConstantOperand(scope, a, b, operator) {
    if (operator === "==" || operator === "!=") {
        if (
            (isNullOrUndefined(a) && hasConstantNullishness(scope, b)) ||
             ...
             * equality.
             */
            (isAlwaysNew(scope, a) && isAlwaysNew(scope, b))
        ) {
            return b;
        }
