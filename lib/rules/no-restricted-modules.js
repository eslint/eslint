...
module.exports = {
    meta: {
        deprecated: {
            message: "Node rule were moved out of ESLint core.",
            url: "https://eslint.org/docs/latest/use/migrating-to-7.0.0#deprecate-node-rules",
            deprecatedSince: "7.0.0",
            availableUntil: null,
            replacedBy: [
                {
                    message: "ESLint Stylistic Maintains now deprecated node rules",
                    plugin: {
                        name: "@eslint-community/eslint-plugin-n",
                        url: "https://github.com/eslint-community/eslint-plugin-n"
                    },
                    rule: {
                        name: "no-restricted-modules",
                        url: "https://github.com/eslint-community/eslint-plugin-n/tree/master/docs/rules/no-restricted-modules.md"
                    }
                }
            ]
        },
