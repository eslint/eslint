...
module.exports = {
        ...
        schema: [
            {
                type: "object",
                properties: {
                    ignoreCharClasses: {type: "boolean"}
                },
    ...
    create(context) {
        ...
        const ignoreCharClasses = context.options[0] && context.options[0].ignoreCharClasses;
            ...
            if (typeof node.value === "string" || isTemplateElement) {
                ...
                parseRegExp(node.regex.pattern)
                    ...
                    .filter(charInfo => {
                        ...
                        if (ignoreCharClasses) {
                            validEscapes = union(REGEX_CHARCLASS_ESCAPES, REGEX_NON_CHARCLASS_ESCAPES);
                        } else {
                            validEscapes = charInfo.inCharClass ? REGEX_CHARCLASS_ESCAPES : REGEX_NON_CHARCLASS_ESCAPES;
                        }

                        return !validEscapes.has(charInfo.text);
                    })
