...
module.exports = {
    meta: {
        ...
        messages: {
            removeEscape: "Remove unnecessary escape. This maintains the current functionality.",
            escapeBackslash: "Escape the backslash to include the actual backslash character."
        },
