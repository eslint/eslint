...
/**
 * Determines whether an opening parenthesis `(` or bracket `[` needs to be preceded by a semicolon.
 * This opening parenthesis or braket should be at the start of an `ExpressionStatement` or at the start of the body of an `ArrowFunctionExpression`.
