...
function isImportAttributeKey(node) {
    ...
    if (
        ...
        if (
            objectExpression.parent.type === "ImportExpression" &&
        ...
        // nested key
        if (
            objectExpression.parent.type === "Property" &&
            objectExpression.parent.value === objectExpression
        ) {
            return isImportAttributeKey(objectExpression.parent.key);
        }
    }
