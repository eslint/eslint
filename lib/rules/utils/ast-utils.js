...
/**
 * Check whether the given node is a string literal not surrounded by parentheses.
 * @param {ASTNode} node The node to check.
 * @param {SourceCode} sourceCode The source code object to get tokens.
 * @returns {boolean} `true` if the node is a string literal not surrounded by parentheses.
 */
