    ...
    create(context) {
        ...
        return {
            ...
            onCodePathEnd(codePath) {
                ...
                /**
                 * A stack of segments to visit.
                 * @type {CodePathSegment[]}
                 */
                const segmentStack = [codePath.initialSegment];

                /**
                 * A collection of segments to avoid duplicate visits.
                ...
                while (segmentStack.length > 0) {
                    const segment = segmentStack.shift();
                    ...
                    // If a segment has `super()`, there is no need to check the next segments.
                    if (!info.superCalled) {
                        segmentStack.push(
                            ...segment.nextSegments
                                .filter(
                                     ...
                                     * When there is a loop, nextSegments may contain already visited segments.
                                     */
                                    seg => !visited.has(seg)
                                )
                        );
