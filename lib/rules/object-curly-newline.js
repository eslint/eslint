 ...
 * @returns {boolean} `true` if the option is a plain object, otherwise `false`
 */
...
function isNodeSpecificOption(option) {
    return isPlainObject(option) || lodash.isString(option);
}
...
function normalizeOptions(options) {
    if (isPlainObject(options) && Object.values(options).some(isNodeSpecificOption)) {
        return {
