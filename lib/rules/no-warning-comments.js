        ...
        function checkComment(node) {
            ...
            matches.forEach(({ type, comment }) => {
                ...
                for (const c of comment.trim().split(/\s+/u)) {
                    commentsToDisplay = commentsToDisplay.trim();
                    if (c.length + commentsToDisplay.length <= CHAR_LIMIT) {
                        commentsToDisplay = `${commentsToDisplay} ${c}`;
                    } else {
                        truncated = true;
                    }
                }
                ...
                context.report({
                    ...
                    data: {
                        type,
                        comment: `${commentsToDisplay.trim()}${truncated ? "..." : ""}`
                    }
                });
            });
        }
