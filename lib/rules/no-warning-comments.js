...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Checks whether or not the specified comment contains whitelisted text.
         * @param {string} comment The comment which is checked.
         * @returns {boolean} `true` if the comment contains whitelisted text.
         */
        function commentIsWhitelisted(comment) {
            for (const item of whitelist) {
                const regex = new RegExp(item, "ui");
        ...
        function checkComment(node) {
            ...
            if (commentIsWhitelisted(node.value)) {
                return;
            }
