...
module.exports = {
    meta: {
        ...
        messages: {
            expectedAtEnd: "Method .{{arrayMethodName}}() expected a value to be returned at the end of {{name}}.",
        ...
        function checkLastSegment(node) {
            ...
            if (messageId) {
                ...
                context.report({
                    ...
                    messageId,
                    data: { name, arrayMethodName: funcInfo.arrayMethodName }
                });
            }
        }
                ...
                if (messageId) {
                    context.report({
                        ...
                        data: {
                            ...
                            arrayMethodName: funcInfo.arrayMethodName
                        }
                    });
                }
            },
