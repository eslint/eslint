 ...
 */
/** @typedef {import("./utils/rule").Range} Range */
/** @typedef {import("./utils/rule").Reference} Reference */
...
module.exports = rule({
    ...
    create(context) {
        ...
        /**
         * Makes a block scope.
         * @param {AST<"Node">} node - A node of a scope.
         * @returns {void}
         */
         ...
         * @param {AST<"VariableDeclaration">} node - A node to get variables.
         * @returns {void}
         */
