        ...
        function check(node) {
            ...
            if (options.multiline) {
                for (let i = 0; i < elements.length; i++) {
                    ...
                    const elementFirst = sourceCode.getFirstToken(element);
                    const elementLast = sourceCode.getLastToken(element);

                    if (options.multiline && !astUtils.isTokenOnSameLine(elementFirst, elementLast)) {
                        elementBreak = true;
