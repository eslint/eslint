...
module.exports = {
    ...
    create(context) {
         ...
         */
        function getReportingLoc(node, name, isMissing) {
            ...
            if (blockStartLoc.has(name)) {
                ...
                return sourceCode.getFirstToken(node.body).loc;
            }
            ...
            if (name === "while") {
                return isMissing ? {
                    start: sourceCode.getTokenBefore(node.body).loc.start,
                    end: node.body.loc.start
                } : sourceCode.getFirstToken(node.body).loc;
            }
            ...
            return {
                ...
                check() {
                    if (this.expected !== null && this.expected !== this.actual) {
                        if (this.expected) {
                            const loc = getReportingLoc(node, name, true);
                            ...
                            const loc = getReportingLoc(node, name, false);
