...
module.exports = {
    ...
    create(context) {
        ...
        function isUnderscored(name) {
            ...
            // if there's an underscore, it might be A_CONSTANT or ignored strings,
            // which is okay
            return !config.ignorePattern.test(name) && name.indexOf("_") > -1 && name.indexOf("_") > -1 && name !== name.toUpperCase();
        }
