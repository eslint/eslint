...
module.exports = {
    meta: {
        ...
        messages: {
            max: "Line {{lineNumber}} has a length of {{lineLength}}. Maximum allowed is {{maxLength}}.",
            maxComment: "Line {{lineNumber}} has a comment length of {{lineLength}}. Maximum allowed is {{maxCommentLength}}."
        }
    },
