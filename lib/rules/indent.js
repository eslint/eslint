        ...
        const baseOffsetListeners = {
            ...
            ConditionalExpression(node) {
                ...
                if (!options.flatTernaryExpressions ||
                    ...
                    offsets.setDesiredOffset(questionMarkToken, firstToken, options.ConditionalExpression);
                    offsets.setDesiredOffset(colonToken, firstToken, options.ConditionalExpression);

                    offsets.setDesiredOffset(firstConsequentToken, firstToken,
                        options.offsetTernaryExpressions ? options.ConditionalExpression + 1 : options.ConditionalExpression);
