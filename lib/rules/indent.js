...
module.exports = {
    ...
    create(context) {
        ...
        const DEFAULT_CLASS_BODY_INDENT = 1;
        ...
        const options = {
            ...
            ClassDeclaration: DEFAULT_CLASS_BODY_INDENT,
            ClassExpression: DEFAULT_CLASS_BODY_INDENT,
            MemberExpression: 1,
            ArrayExpression: 1,
            ObjectExpression: 1,
            ArrayPattern: 1,
        ...
        */
        ...
        function addBlockIndent(node) {
            ...
            } else if (node.parent && node.parent.type === "ClassDeclaration") {
                blockIndentLevel = options.ClassDeclaration;
            } else if (node.parent && node.parent.type === "ClassExpression") {
                blockIndentLevel = options.ClassExpression;
            } else {
                blockIndentLevel = 1;
            }
