...
module.exports = (function () {
	 ...
	 * @returns {Object} The timing data object
	 */
	function getData() {
		return { ...data };
	}
	...
	/**
	 * Merge timing data from another source
	 * @param {Object} otherData The timing data to merge
	 * @returns {void}
	 */
	function mergeData(otherData) {
	 ...
	 * @param {Object} [dataToDisplay] The data to display. If not provided, uses internal data.
	 * @returns {void}
	 */
	function displayData(dataToDisplay) {
		display(dataToDisplay || data);
	}

	if (enabled && require("node:worker_threads").isMainThread) {
		process.on("exit", () => {
			display(data);
		});
	}
