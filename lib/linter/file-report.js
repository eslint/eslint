...
class FileReport {
	...
	addErrors(descriptors) {
		descriptors.forEach(descriptor => this.addError(descriptor));
	}
	...
	addFatals(descriptors) {
		descriptors.forEach(descriptor => this.addFatal(descriptor));
	}
	...
	addWarnings(descriptors) {
		descriptors.forEach(descriptor => this.addWarning(descriptor));
	}
}
