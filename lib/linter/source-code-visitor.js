...
class SourceCodeVisitor {
	...
	/**
	 * Fast path for calling functions with exactly two arguments.
	 * Avoids rest/spread overhead for CPA events.
	 * @param {string} name The name of the function to call.
	 * @param {any} arg1 The first argument to pass.
	 * @param {any} arg2 The second argument to pass.
	 * @returns {void}
	 */
	callSync2(name, arg1, arg2) {
		const funcs = this.#functions.get(name);
