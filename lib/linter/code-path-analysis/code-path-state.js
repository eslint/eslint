 ...
 * @property {ChainContext} upper The previous `ChainContext`.
 * @property {number} countChoiceContexts The number of choice contexts inside of
 *      the `ChainContext`.
 */

/**
 * Represents the context for a `while` loop.
 * @typedef {Object} WhileLoopContext
