...
/**
 * Represents the context for a `break` statement.
 * @property {BreakContext} upper The previous `BreakContext`.
 * @property {boolean} breakable The flag to indicate it can break by
 *      an unlabeled BreakStatement.
 * @property {string|null} label The label for the `break`.
 * @property {ForkContext} brokenForkContext
 */
class BreakContext {
...
class LoopContextBase {
    ...
    /**
     * Creates a new instance.
     * @param {LoopContext} upperContext The previous `LoopContext`.
     ...
     */
    constructor(upperContext, type, label) {
...
class WhileLoopContext extends LoopContextBase {
    ...
    constructor(upperContext, label, breakContext) {
        super(upperContext, "WhileStatement", label);

        /**
         * The segments where `continue` will jump to.
...
class DoWhileLoopContext extends LoopContextBase {
    ...
    constructor(upperContext, label, breakContext, forkContext) {
        super(upperContext, "DoWhileStatement", label);
...
/**
 * Represents the context for a `do-while` loop.
 * @typedef {Object} DoWhileLoopContext
 * @property {LoopContext} upper The previous `LoopContext`.
 * @property {string} type The node type represented by this context.
 * @property {string|null} label The label for the loop from an enclosing `LabeledStatement`.
 * @property {boolean|undefined} test The hardcoded literal boolean test condition for
 *      the loop. Used to catch infinite or skipped loops.
 * @property {ForkContext} continueForkContext The fork context for `continue`.
 * @property {ForkContext} brokenForkContext The fork context for `break`.
 */

/**
 * Represents the context for a `for` loop.
 * @typedef {Object} ForLoopContext
 * @property {LoopContext} upper The previous `LoopContext`.
 * @property {string} type The node type represented by this context.
 * @property {string|null} label The label for the loop from an enclosing `LabeledStatement`.
 * @property {boolean|undefined} test The hardcoded literal boolean test condition for
 *      the loop. Used to catch infinite or skipped loops.
 * @property {Array<CodePathSegment>|null} endOfInitSegments
 * @property {Array<CodePathSegment>|null} testSegments The segments representing the
 *      test condition for the loop.
 * @property {Array<CodePathSegment>|null} endOfTestSegments
 * @property {Array<CodePathSegment>|null} updateSegments The segments representing the
 *      update expression for the loop.
 * @property {Array<CodePathSegment>|null} endOfUpdateSegments
 * @property {Array<CodePathSegment>|null} continueDestSegments The segments where `continue`
 *      will jump to.
 * @property {ForkContext} brokenForkContext The fork context for `break`.
 */

/**
 * Represents the context for a `for-in` or `for-of` loop.
 * @typedef {Object} ForInLoopContext
 * @property {LoopContext} upper The previous `LoopContext`.
 * @property {string} type The node type represented by this context.
 * @property {string|null} label The label for the loop from an enclosing `LabeledStatement`.
 * @property {boolean|undefined} test The hardcoded literal boolean test condition for
 *      the loop. Used to catch infinite or skipped loops.
 * @property {Array<CodePathSegment>|null} prevSegments
 * @property {Array<CodePathSegment>|null} leftSegments
 * @property {Array<CodePathSegment>|null} endOfLeftSegments
 * @property {Array<CodePathSegment>|null} continueDestSegments The segments where `continue`
 *      will jump to.
 * @property {ForkContext} brokenForkContext The fork context for `break`.
 */
 ...
 * @typedef {WhileLoopContext|DoWhileLoopContext|ForLoopContext|ForInLoopContext} LoopContext
 */
...
class SwitchContext {
    ...
    constructor(upperContext, hasCase) {
        ...
        /**
         * Indicates if a `default` case exists.
         * @type {boolean}
         */
