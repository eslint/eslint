...
function mergeExtraSegments(context, segments) {
     ...
     * that the number of segments that the context allows. `context.count` indicates
...
class ForkContext {
    ...
    constructor(idGenerator, upper, count) {
         ...
         * which forks the code path outside of normal flow.
         * @type {number}
         */
        this.count = count;
    ...
    /**
     * Creates new segments in this context and does not appends them to the end
    ...
    /**
     * Creates a new root context, meaning that there are no parent parent
     * fork contexts.
     * @param {IdGenerator} idGenerator An identifier generator for segments.
