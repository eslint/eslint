...
/**
 * @import { DirectiveType, Language, LanguageOptions, RuleConfig, RuleDefinition } from "@eslint/core";
 * @import * as types from "eslint";
 */
 ...
 * @property {DirectiveType} type Type of directive
 ...
 * @param {DirectiveType} options.type The type of directive comment
...
class Linter {
	 ...
	 * @param {"flat"} [options.configType="flat"] The type of config used. Retained for backwards compatibility, will be removed in future.
	 * @param {Array<string>} [options.flags=[]] The feature flags to enable.
	 * @param {WarningService} [options.warningService=new WarningService()] The warning service instance to use.
	 */
	constructor({
		cwd,
		configType = "flat",
	...
	/**
	 * Static getter for package version.
	 ...
	 * @returns {{fixed:boolean,messages:LintMessage[],output:string}} The result of the fix operation as returned from the `SourceCodeFixer`.
	 */
