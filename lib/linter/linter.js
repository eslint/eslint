...
function createRuleListeners(rule, ruleContext) {
	...
	try {
		...
		// Preserve original message for RuleTester fatal test cases
		ex.messageForTest = ex.message;
...
class Linter {
	...
	#flatVerifyWithoutProcessors(file, providedConfig, providedOptions) {
		...
		try {
			...
			// Preserve original message for RuleTester fatal test cases (only if not already set, e.g. by createRuleListeners)
			if (typeof err.messageForTest === "undefined") {
				err.messageForTest = err.message;
			}
