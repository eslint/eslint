...
class Linter {
	 ...
	 * @param {"flat"} [options.configType="flat"] The type of config used. Retrained for backwards compatibility, will be removed in future.
	 * @param {Array<string>} [options.flags] The feature flags to enable.
	 * @param {WarningService} [options.warningService] The warning service instance to use.
	 */
	constructor({
		cwd,
		configType = "flat",
