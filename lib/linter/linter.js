                ...
                for (const { config: inlineConfig, node } of inlineConfigResult.configs) {
                    ...
                    Object.keys(inlineConfig.rules).forEach(ruleId => {
                        ...
                        try {
                            ...
                            const mergedOptions = deepMergeArrays(rule.meta && rule.meta.defaultOptions, ruleOptions.slice(1));
                            const mergedValue = [ruleOptions[0], ...mergedOptions];
                            ...
                            mergedInlineConfig.rules[ruleId] = mergedValue;
                        } catch (err) {
