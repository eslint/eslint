...
const { LinterWarningService } = require("../services/linter-warning-service");
 ...
 * @property {LinterWarningService} warningService The warning service.
 */
...
class Linter {
	 ...
	 * @param {LinterWarningService} [config.warningService] The warning service to use.
	 */
	constructor({
		cwd,
		configType = "flat",
		flags = [],
		warningService = new LinterWarningService(),
	} = {}) {
