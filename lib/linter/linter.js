 ...
 * @returns {Array} of rule options, empty Array if none
 */
function getRuleOptionsInline(ruleId, defaultOptions, ruleValue) {
                ...
                for (const { config: inlineConfig, node } of inlineConfigResult.configs) {
                    ...
                    Object.keys(inlineConfig.rules).forEach(ruleId => {
                        ...
                        try {
                            ...
                            const ruleOptions = getRuleOptionsInline(ruleId, rule.meta && rule.meta.defaultOptions, ruleValue);
