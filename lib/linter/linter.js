...
class Linter {
	 ...
	 * @param {string|SourceCode} textOrSourceCode The text to parse or a SourceCode object.
	 * @param {Linter.LegacyConfig|Linter.Config|Linter.Config[]} config An ESLintConfig instance to configure everything.
	 * @param {string|Linter.LintOptions} [filenameOrOptions] The optional filename of the file being checked.
