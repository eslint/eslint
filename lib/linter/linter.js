 ...
 * @param {Object} [session] An object that exposes session information to rules.
 * @returns {LintMessage[]} An array of reported problems
 */
function runRules(sourceCode, configuredRules, ruleMapper, parserName, languageOptions, settings, filename, disableFixes, cwd, physicalFilename, ruleFilter, session) {
...
class Linter {
    ...
    _verifyWithFlatConfigArrayAndWithoutProcessors(textOrSourceCode, providedConfig, providedOptions) {
        ...
        const session = {
            isDirectoryIgnored: dirPath => slots.lastConfigArray.isDirectoryIgnored(dirPath),
            isFileIgnored: filePath => slots.lastConfigArray.isFileIgnored(filePath)
        };
