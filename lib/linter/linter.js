...
class Linter {
	 ...
	 * @param {string|undefined} [config.cwd] Path to a directory that should be considered as the current working directory, can be `undefined`.
	 * @param {"flat"|"eslintrc"|undefined} [config.configType="flat"] The type of config used.
	 * @param {Array<string>|undefined} [config.flags] The feature flags to enable.
	 * @param {WarningService|undefined} [config.warningService] The warning service to use.
	 */
	constructor({
		cwd,
		configType = "flat",
