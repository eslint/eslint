...
function createLintingProblem(options) {
    ...
    /*
     * If the location returned from the parser is 0-indexed,
     * adjust it to be 1-indexed. We always want ESLint reporting lines and
    ...
    return {
        ...
        column: loc.start.column + columnOffset,
        endLine: loc.end.line + lineOffset,
