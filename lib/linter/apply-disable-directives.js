            ...
            switch (directive.type) {
                case "disable":
                    if (!isProblemSuppressedBefore) {
                        ...
                        } else if (directive.ruleId === problem.ruleId && !currentGlobalDisableDirective && suppressions.length === 0) {
                ...
                case "enable":
                    if (!isProblemSuppressedBefore) {
                        ...
                        if ((directive.ruleId === null || directive.ruleId === problem.ruleId) && suppressions.length !== 0) {
                            usedDisableDirectivesForProblem.forEach(usedDirective => {
                                if (usedDirective.ruleId === problem.ruleId) {
