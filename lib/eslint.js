    ...
    api.verify = function(text, config, filename, saveState) {
        ...
        if (ast) {
            ...
            scopeManager = escope.analyze(ast, {
                ...
                ecmaVersion: (currentConfig.ecmaFeatures.blockBindings || currentConfig.ecmaFeatures.modules) ? 6 : 5,
                sourceType: currentConfig.ecmaFeatures.modules ? "module" : "script"
            });
