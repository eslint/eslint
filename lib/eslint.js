...
module.exports = (function() {
    ...
    api.verify = function(textOrSourceCode, config, filename, saveState) {
        ...
        if (ast) {
            ...
            Object.keys(config.rules).filter(function(key) {
                ...
                try {
                    rule = ruleCreator.register ? ruleCreator.register(new RuleContext(
                        key, api, severity, options,
                        config.settings, config.ecmaFeatures, ruleCreator.meta, ruleCreator.schema
                    )) : ruleCreator(new RuleContext(
                        key, api, severity, options,
                        config.settings, config.ecmaFeatures, ruleCreator.meta, ruleCreator.schema
                    ));
     ...
     * @param {Object} meta Metadata of a rule
     * @returns {void}
     */
