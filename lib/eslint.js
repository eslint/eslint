...
module.exports = (function() {
    ...
    api.verify = function(text, config, saveState) {
        ...
        Object.keys(config.rules).filter(function(key) {
            ...
            } else if (Object.prototype.toString.call(config.rules[key]) === "[object Array]") {
            ...
            if (Object.prototype.toString.call(config.rules[key]) === "[object Array]") {
                // The additional config data is after the bool value
                configInfo = config.rules[key].slice(1);
            }

            if (ruleCreator) {
                rule = ruleCreator(new RuleContext(key, api, configInfo));
