...
module.exports = (function() {
     ...
     * @returns {void}
     */
    api.define = function define(ruleIdOrRules, ruleModule){
        if(arguments.length === 1) {
            Object.getOwnPropertyNames(ruleIdOrRules).forEach(function(ruleId){
                define(ruleId, ruleIdOrRules[ruleId]);
            });
        } else {
            rules.define(ruleIdOrRules, ruleModule);
        }
    };
