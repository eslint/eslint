...
/**
 * @returns {Array<string>} the default and custom ignore patterns
 */
IgnoredPaths.prototype.dumpJoinedResults = function() {
    return [].concat(

        /* eslint-disable no-underscore-dangle */
        this.ig.default._rules.map(function(v) {
            return v.pattern;
        }),
        this.ig.custom._rules.map(function(v) {
            return v.pattern;
        }));
