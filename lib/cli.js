    ...
    async execute(args, text) {
        ...
        if (currentOptions.version) {
            ...
            const report = useStdin
                ? await engine.executeOnText(text, currentOptions.stdinFilename, true)
                : await engine.executeOnFiles(files);
            ...
            if (currentOptions.quiet) {
                ...
                report.results = ESLint.getErrorResults(report.results);
            }

            if (await printResults(engine, report.results, currentOptions.format, currentOptions.outputFile)) {
