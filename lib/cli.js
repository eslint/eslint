...
const cli = {
    ...
    async execute(args, text) {
        ...
        // FIXME: this function shouldn't be async (Node 4 support)
        let currentOptions;
        ...
        if (currentOptions.version) { // version from package.json
            ...
            const report = text ? engine.executeOnText(text, currentOptions.stdinFilename, true) : await engine.executeOnFiles(files, true);
