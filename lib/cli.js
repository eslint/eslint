...
async function translateOptions({
    ...
    if (configType === "flat") {
        ...
        if (reportUnusedDisableDirectives || reportUnusedDisableDirectivesSeverity !== void 0) {
            if (reportUnusedDisableDirectivesSeverity === void 0) {
                overrideConfig[0].linterOptions = {
                    reportUnusedDisableDirectives: reportUnusedDisableDirectives ? "error" : "off"
                };
            } else {
                overrideConfig[0].linterOptions = {
                    reportUnusedDisableDirectives: normalizeSeverityToString(
                        reportUnusedDisableDirectivesSeverity
                    )
                };
            }
    ...
    if (configType === "flat") {
        ...
        if (reportUnusedDisableDirectives || reportUnusedDisableDirectivesSeverity !== void 0) {
            if (reportUnusedDisableDirectivesSeverity === void 0) {
                options.reportUnusedDisableDirectives = reportUnusedDisableDirectives ? "error" : "off";
            } else {
                options.reportUnusedDisableDirectives = normalizeSeverityToString(
                    reportUnusedDisableDirectivesSeverity
                );
            }
        }
