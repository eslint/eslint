    ...
    if (configType === "flat") {
        ...
        if (reportUnusedDisableDirectives || reportUnusedDisableDirectivesSeverity !== void 0) {
            overrideConfig[0].linterOptions = {
                reportUnusedDisableDirectives:
                  normalizeSeverity(
                      reportUnusedDisableDirectivesSeverity === void 0 ? reportUnusedDisableDirectives : reportUnusedDisableDirectivesSeverity, "error"
                  )
            };
        }
    ...
    if (configType === "flat") {
        ...
        if (reportUnusedDisableDirectives || reportUnusedDisableDirectivesSeverity !== void 0) {
            options.reportUnusedDisableDirectives =
              normalizeSeverity(reportUnusedDisableDirectivesSeverity === void 0 ? reportUnusedDisableDirectives : reportUnusedDisableDirectivesSeverity, "error");
        }
    }
