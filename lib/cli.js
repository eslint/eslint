...
const fs = require("fs"),
    ...
    { normalizeSeverity } = require("./shared/severity");
...
async function translateOptions({
    ...
    if (configType === "flat") {
        ...
        if (reportUnusedDisableDirectives || reportUnusedDisableDirectivesSeverity !== void 0) {
            overrideConfig[0].linterOptions = {
                // eslint-disable-next-line no-nested-ternary -- Best way for now
                reportUnusedDisableDirectives: reportUnusedDisableDirectivesSeverity === void 0
                    ? (reportUnusedDisableDirectives ? "error" : "off") : normalizeSeverity(reportUnusedDisableDirectivesSeverity)
            };
        }
    ...
    if (configType === "flat") {
        ...
        if (reportUnusedDisableDirectivesSeverity !== void 0 || reportUnusedDisableDirectives) {
            options.reportUnusedDisableDirectives =
                // eslint-disable-next-line no-nested-ternary -- Best way for now
                reportUnusedDisableDirectivesSeverity === void 0 ? (reportUnusedDisableDirectives ? "error" : "off") : normalizeSeverity(reportUnusedDisableDirectivesSeverity);
        }
    }
