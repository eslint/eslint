...
function translateOptions(cliOptions) {
    return {
        ...
        numParallel: cliOptions.numParallel
    };
}
...
/**
 * decide the process exit code based on the lint report.
 * @param {Object} currentOptions options from optionator().parse.
 * @param {LintReport} report lint report.
 * @param {CLIEngine} engine CLIEngine instance.
 * @returns {number} process exit code.
 */
function processReport(currentOptions, report, engine) {
