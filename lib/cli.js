...
async function translateOptions({
    ...
    if (configType === "flat") {
        ...
        if (reportUnusedDisableDirectives || reportUnusedDisableDirectivesSeverity) {
            if (!overrideConfig[0].linterOptions) {
                overrideConfig[0].linterOptions = {};
            }
            overrideConfig[0].linterOptions.reportUnusedDisableDirectives = reportUnusedDisableDirectivesSeverity || (reportUnusedDisableDirectives ? "error" : void 0);
        }
    ...
    if (configType === "flat") {
        ...
        options.reportUnusedDisableDirectives = reportUnusedDisableDirectivesSeverity || (reportUnusedDisableDirectives ? "error" : void 0);
    }
