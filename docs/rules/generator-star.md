...
**Deprecation notice**: This rule is deprecated and has been superseded by the [generator-star-spacing](generator-star-spacing.md) rule. It will be removed in ESLint v1.0.
