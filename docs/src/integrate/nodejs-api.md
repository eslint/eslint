...
- `configType` - The type of config used. Refrained for backwards compatibility, will be removed in future. Only the value `"flat"` is accepted, and the default is also `"flat"`.
