...
* Raw characters from U+0000 to U+001F.
* Escaped raw characters from U+0000 to U+001F.
...
var pattern6 = new RegExp("\\x0C"); // escaped raw U+000C character in the pattern
```
