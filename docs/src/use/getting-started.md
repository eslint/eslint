...
To use ESLint, you must have [Node.js](https://nodejs.org/en/) (`^20.19.0`, `^22.12.0`, or `>=24`) installed and built with SSL support. (If you are using an official Node.js distribution, SSL is always built in.)
