...
You can see the TypeScript types for the flat config file format in `lib/types`. The interface for the objects in the config’s array is called `Linter.Config`.
