[ESLint Node.js API Reference](../index.md) / [source-code/token-store/forward-token-comment-cursor](../modules/source_code_token_store_forward_token_comment_cursor.md) / export=
