...
* `baseConfig` - Set to false to disable base config file (default: `true`). Could be set to alternative file path or an object as well, corresponds to `--base-config`.
