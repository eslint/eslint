...
* `options` - (optional) Additional options for this run.
    ...
    * `processorOptions` - (optional) An object that is passed to the `preprocess` and `postprocess` functions, as described in the [Processors in Plugins](/docs/developer-guide/working-with-plugins.md#processors-in-plugins) documentation.
